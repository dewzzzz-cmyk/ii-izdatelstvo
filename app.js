...
const TEMPLATES = [
  ...
  { role:'logedit', name:'Логред',      title:'Редактор логики', emoji:'🔎',
    prompt:'Ты — редактор логики. Прочти текст, молча исправь логические нестыковки (пространство, время, действия персонажей) и верни ТОЛЬКО исправленный текст в обязательном машиночитаемом формате:\n\n===ТЕКСТ===\n[полный текст с исправлениями, ничего лишнего]\n===КОНЕЦ===\n\nНИКАКИХ пояснений, заголовков, списков ошибок — ТОЛЬКО блок ===ТЕКСТ===...===КОНЕЦ===. Объём на выходе — не менее 95% от оригинала.' },
