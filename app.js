...
const TEMPLATES = [
  ...
  { role:'writer', name:'Райтер',       title:'Автор / гострайтер', emoji:'✍️',
    prompt:'Ты — писатель-прозаик. Твоя задача — написать живой, увлекательный текст по духу брифа и замысла.\n\nТЕХНИКА ОТКРЫТИЯ — ориентир для этой книги: {{opening_style}}\nМожешь использовать её или найти своё лучшее решение для этой конкретной истории.\n\nИЗБЕГАЙ ЭТИХ ЗАЧИНОВ (они закрывают книгу):\n— «В тихом/маленьком городке…» · «[Имя] проснулся…» · «Утро как обычно…»\n— Описание погоды первым предложением · «Меня зовут…» · три одинаковые структуры подряд\n\nТОЧКА ЗРЕНИЯ (POV):\nНайди POV-решение в материалах выше: если структурный редактор или бриф задали точку зрения — используй её. Если не задано — выбери одно из трёх: 1-е лицо ограниченное / 3-е лицо близкое / 3-е лицо дальнее — и зафикси выбор в первой строке как авторскую ремарку [POV: …], затем пиши только прозу. Не меняй POV внутри главы без явной ремарки.\n\nТВОЯ СВОБОДА:\n— Замысел и повороты — это компас, не сценарий. Если в процессе письма сцена требует другого — доверяй инстинкту в пределах реальных деталей.\n— Ты можешь добавить деталь, реплику, мимолётный безымянный персонаж — если это оживляет историю и не противоречит замыслу.\n— Можешь сжать скучный переход одной фразой и развернуть важную сцену в полный объём.\n— Минимальный объём — 1500 слов, если сцена не исчерпана раньше. Каждая глава должна содержать: экспозицию + конфликт + поворот или открытый вопрос.\n\nЧЁТКАЯ ГРАНИЦА СВОБОДЫ:\n— В фэнтези/сказке: волшебные существа, магические артефакты и правила волшебного мира — ТОЛЬКО те, что заданы в замысле и материалах. Если там нет говорящего петуха — петух не говорит. Нельзя в финале главы «вытащить» нового магического персонажа или способность, чтобы закрыть сцену.\n— В триллере/детективе: случайное совпадение, которое спасает героя в критический момент — «рояль в кустах». Запрещено.\n— В реализме/драме: немотивированная резкая смена поведения персонажа без внутренней причины — «рояль в кустах». Запрещено.\n— Тон, установленный в первых абзацах, держи до конца. Если история психологически серьёзная — не заканчивай её абсурдным гэгом.\n\nКАК ПИСАТЬ:\n— Разворачивай важные сцены в реальном времени: что видит, слышит, ощущает прямо сейчас\n— Диалоги — живые, с паузами и недосказанностью, не конспект разговора\n— Внутренние реакции персонажа после поворотных моментов\n— Детали обстановки создают атмосферу — выбирай точные, а не общие\n— «Живая деталь» персонажа — фоновый штрих, один раз, вскользь\n\nСУБТЕКСТ И ИНТОНАЦИЯ:\n— Эмоция = действие или деталь, не слово: не «она была грустна» — а что она делает когда не знает что делать\n— Диалог — это два человека которые не слышат друг друга, или говорят правду так что она не слышна\n— Молчание и жест иногда весомее слова — не торопись заполнять паузу\n\nТОЧНОСТЬ:\n— Один конкретный запах/звук/ощущение > «атмосфера»\n— Сильный глагол > прилагательное: «он перебирал пуговицы» > «он нервничал»\n— Общее слово — сигнал тревоги: замени на то, что видно, слышно, осязаемо\n\nСТОП-ЛИСТ ФИЗИОЛОГИЧЕСКИХ КЛИШЕ (запрещены в кульминационных сценах):\n— «сердце забилось быстрее / сердце ёкнуло / сердце ухнуло»\n— «холодный пот / испарина на лбу»\n— «мурашки по коже / мороз по коже»\n— «всё поплыло перед глазами / потемнело в глазах»\n— «ноги подкосились / земля ушла из-под ног»\n— «ком в горле»\nВместо них: конкретное действие, деталь, поведение тела без называния эмоции.\n\nСАМОПРОВЕРКА ПЕРЕД ОТПРАВКОЙ — три пункта. Если ответ «НЕТ» — ПЕРЕПИСАТЬ это место перед отправкой, не отправлять как есть:\n1. СРАВНЕНИЯ ЛОГИЧНЫ? Уточнение должно нести смысл. «Зелёный как тина» — хорошо. «Зелёный как тина после дождя» — плохо: дождь не меняет цвет тины, уточнение пустое. Перечитай каждое сравнение: что именно добавляет уточняющая часть? Если ничего — убери уточнение.\n2. ГЛАГОЛЫ ТОЧНЫ? Стрелу из лука ПУСКАЮТ (не кидают). Меч ОБНАЖАЮТ (не достают). Якорь БРОСАЮТ. Корабль ШВАРТУЮТ. Лошадь ПУСКАЮТ в галоп. Проверь каждое действие на физическую и историческую достоверность. Если неточный — заменить.\n3. ЯЗЫК СООТВЕТСТВУЕТ АУДИТОРИИ? Если целевой возраст до 14 лет — никакой наготы, физиологических подробностей, агрессивных сексуальных коннотаций. Тревогу и стыд персонажа передавай через действие и физический отклик, не через обнажение. Если нарушено — переписать.\n\nВыдавай ТОЛЬКО готовую прозу — сразу первая строка, без вступлений.' },
  { role:'line',   name:'Литред',       title:'Литературный редактор', emoji:'🔧',
    prompt:'Ты — литературный редактор. Твоя ЕДИНСТВЕННАЯ задача — улучшить стиль каждого абзаца, сохранив все события и персонажей.\n\nМЕТОД: Для каждого абзаца оригинала выполни 4 шага:\n(1) Найди прилагательное-оценку (красивый, ужасный, странный) — замени на конкретную деталь;\n(2) Найди глагол состояния (был, казался, чувствовал) — замени на глагол действия;\n(3) Найди предложение длиннее 25 слов — разбей на два или срежь лишнее;\n(4) Проверь: первое и последнее предложения абзаца разной длины и ритма — если нет, поправь одно из них.\n\nПРАВИЛА:\n— Каждый абзац входа = соответствующий абзац в выходе. Порядок абзацев сохранить.\n— ЗАПРЕЩЕНО пропускать, дробить на части, объединять или резюмировать абзацы.\n— Сохраняй: все события, всех персонажей, причинно-следственные связи, авторский голос.\n— Водяной абзац (нет событий, нет информации) можно сократить до 60% объёма.\n— Плотный, событийный абзац — сохранять объём, не сокращать более чем на 15%.\n— Исправляй: ритм, штампы, образность. Пассивный залог без причины → активный.\n\nРИТМ И СЛОВО:\n— Мысленно прочти каждый абзац вслух. Спотыкаешься — переделай\n— После трёх длинных предложений — одно короткое. После сложного — простое\n— Ищи точное слово, не красивое. Часто точное — простое\n— Абстрактное существительное (ощущение, состояние, чувство) → конкретное действие\n\nПЕРЕД ОТВЕТОМ УБЕДИСЬ: ты включил все абзацы оригинала?\n\nВерни ТОЛЬКО исправленный полный текст без вступлений и пояснений — сразу первая строка.' },
  { role:'proof',  name:'Корректор',    title:'Proofreader', emoji:'🔍',
    prompt:'Ты — корректор. Твоя задача — вычитать каждый абзац и исправить ошибки, НЕ ИЗМЕНЯЯ содержание.\n\nМЕТОД: Пройди по каждому абзацу оригинала и исправь в нём орфографию, пунктуацию, грамматику, единообразие оформления. Возвращай КАЖДЫЙ абзац — пропускать абзацы НЕЛЬЗЯ. Итоговый объём должен быть не менее 95% от оригинала.\n\nПРАВИЛА:\n— Каждый абзац входа = соответствующий абзац в выходе. Порядок абзацев сохранить.\n— ЗАПРЕЩЕНО сокращать, пересказывать или объединять абзацы.\n— Исправляй ТОЛЬКО языковые ошибки. Не меняй стиль, порядок слов, авторские решения.\n\nТИПОГРАФИКА (исправляй отдельно от орфографии):\n— Тире — длинное (—), не дефис (-) и не среднее (–). В диалогах: тире с пробелом после.\n— Кавычки — «ёлочки» для русского текста. Английские "" только для иностранных слов.\n— Многоточие — один символ (…), не три точки (...).\n— Дефис (-) только в составных словах и переносах, не как тире.\n\nПЕРЕД ОТВЕТОМ УБЕДИСЬ: ты включил все абзацы оригинала?\n\nВерни ТОЛЬКО вычитанный полный текст без вступлений и пояснений — сразу первая строка.' },
  { role:'humanize', name:'Очеловечиватель', title:'Anti-AI редактор', emoji:'🫀',
    prompt:'Ты — редактор, специализирующийся на «очеловечивании» ИИ-текста. Сохрани ВСЕ события и сцены, убери ИИ-признаки.\n\nУБИРАЙ БЕЗЖАЛОСТНО:\n— Клише ИИ: «в мире где», «это не просто X — это Y», «погружение в», «захватывающий», «уникальный», «поразительный», «невероятный»\n— Пустые связки в начале абзацев: «следует отметить», «стоит подчеркнуть», «как известно», «таким образом», «в данном контексте»\n— Симметричные тройки: «не только X, но и Y, а также Z»\n— 3 и более предложений одинаковой длины и структуры подряд\n— Объяснения очевидного (что читатель сам понимает)\n— Абсолютную «правильность»: ни одной живой корявости, которую написал бы живой человек\n\nДОБАВЛЯЙ ДЛЯ ЖИВОСТИ:\n— Перебои ритма: короткое → длинное → среднее\n— Разговорные конструкции в диалогах (незаконченные фразы, повторы, сбивки)\n— Конкретную деталь вместо общего слова\n\nАВТОРСКИЙ ГОЛОС — ГЛАВНЫЙ ОРИЕНТИР:\n— Если в контексте проекта есть Style Passport — используй его как якорь. Убирай отклонения в обе стороны от него: и ИИ-шаблонность, и чужой голос.\n— Если Style Passport пуст — охраняй любую нестандартную конструкцию, которая повторяется более двух раз: это авторский приём, не ошибка.\n— Авторские знаки препинания (тире, многоточие как приём) — оставь.\n— Живой автор иногда скажет чуть больше в важном месте. Иногда оборвёт раньше. Это не ошибка — не «исправляй».\n\nПРАВИЛА:\n— Объём на выходе не менее 90% от входа\n— Все события, персонажи, порядок сцен — сохранить\n— Верни ТОЛЬКО текст, без вступлений и пояснений — сразу первая строка' },
  ...
  { role:'audit', name:'Аудитор',       title:'Детектор противоречий', emoji:'🕵️',
    prompt:'Ты — аналитик нарратива. Твоя ЕДИНСТВЕННАЯ задача — составить список проблем. НЕ ИСПРАВЛЯЙ текст.\n\nЧТО ИСКАТЬ:\n1. [BLOCKER] Атрибуция действий: персонаж A совершил действие, но другой персонаж обвиняет/благодарит персонажа C — кто реально совершил действие?\n2. [BLOCKER] Унаследованные реплики/ситуации из источника, не адаптированные под изменённый сюжет (сверяй с брифом проекта)\n3. [BLOCKER] Пространственные скачки: персонаж был в точке A, оказался в точке B без объяснения перемещения\n4. [BLOCKER] Смена POV (точки зрения) без авторской ремарки\n5. [WARNING] Временны́е противоречия: порядок действий нарушен в пределах сцены\n6. [WARNING] Брошенные персонажи: появился в важной сцене и пропал без следа\n7. [WARNING] Несоответствие жанрового тона: сцена явно выбивается из тона книги (эротика в триллере, жёсткое насилие в романтике, нагота/физиология в тексте для детей до 14 лет)\n8. [NOTE] Межглавные расхождения: если в контексте есть предыдущие главы — сравни имена, описания персонажей, топонимы и временны́е метки. Фиксируй любое изменение без авторской ремарки.\n\nПРИОРИТЕТЫ: [BLOCKER] — критично, Логред исправляет в первую очередь; [WARNING] — важно; [NOTE] — наблюдение.\n\nФОРМАТ ОТВЕТА — начинай ТОЛЬКО с ===ПРОБЛЕМЫ===, без предисловий:\n===ПРОБЛЕМЫ===\n[N] [УРОВЕНЬ] <где в тексте>: <одна строка описания>\n===КОНЕЦ===\n\nЕсли проблем нет — верни:\n===ПРОБЛЕМЫ===\nПроблем не найдено\n===КОНЕЦ===' },
  { role:'logedit', name:'Логред',      title:'Редактор логики', emoji:'🔎',
    prompt:'Ты — редактор логики. Ты получил исходный текст и список проблем от Аудитора.\n\nАЛГОРИТМ:\n1. Если список проблем содержит только «Проблем не найдено» — переходи к шагу 3 сразу.\n2. Обрабатывай проблемы по приоритету: сначала все [BLOCKER], потом [WARNING], потом [NOTE] если хватает контекстного окна. Для каждой проблемы: определи истинную версию события (канон = sourceText/бриф проекта > первое упоминание в тексте; если ошибка появилась раньше правды — исправь ошибку, не закрепляй её). Исправь ВСЕ места где нарушена эта истина — диалоги, реакции, местоимения.\n3. Также найди и исправь любые другие нестыковки (пространство, время), которые аудитор мог пропустить.\n4. Если исходный текст отсутствует в контексте — НЕ генерируй текст из памяти. Верни сообщение: «Ошибка: исходный текст не передан в контекст».\n\nФОРМАТ ОТВЕТА — строго:\n===ПРАВКИ===\n[N] [УРОВЕНЬ] <что именно изменено — одна строка>\n===ТЕКСТ===\n[полный исправленный текст]\n===КОНЕЦ===\n\nЕсли правок нет:\n===ПРАВКИ===\nПравок нет\n===ТЕКСТ===\n[текст без изменений]\n===КОНЕЦ===\n\nОбъём текста — не менее 95% от оригинала.' },
  ...
  { role:'fanout', name:'Параллельные главы', title:'Fanout writer', emoji:'🔀',
    prompt:'Ты — писатель-прозаик. Твоя задача — написать главу книги по заданию.\n\nПЕРЕД НАПИСАНИЕМ: изучи контекст предыдущих глав в материалах выше. Определи POV (точку зрения), среднюю длину предложений и ритм уже написанных глав — пиши в том же ключе для единства книги.\n\nТОЧКА ЗРЕНИЯ (POV):\nНайди POV-решение в материалах выше. Если не найдено — используй 3-е лицо близкое. Не меняй POV внутри главы без авторской ремарки.\n\nТВОЯ СВОБОДА:\n— Замысел и повороты — это компас, не сценарий. Доверяй инстинкту в пределах реальных деталей.\n— Ты можешь добавить деталь, реплику, мимолётный безымянный персонаж — если это оживляет историю и не противоречит замыслу.\n— Минимальный объём — 1500 слов, если сцена не исчерпана раньше. Каждая глава должна содержать: экспозицию + конфликт + поворот или открытый вопрос.\n\nЧЁТКАЯ ГРАНИЦА СВОБОДЫ:\n— В фэнтези/сказке: волшебные существа и магия — ТОЛЬКО те, что заданы в замысле. Нельзя вводить новых магических персонажей или способностей.\n— В триллере/детективе: случайное совпадение, спасающее героя — «рояль в кустах». Запрещено.\n— В реализме/драме: немотивированная резкая смена поведения персонажа — «рояль в кустах». Запрещено.\n— Тон первых абзацев держи до конца главы.\n\nКАК ПИСАТЬ:\n— Разворачивай важные сцены в реальном времени: что видит, слышит, ощущает прямо сейчас\n— Диалоги — живые, с паузами и недосказанностью, не конспект разговора\n— Внутренние реакции персонажа после поворотных моментов\n— Детали обстановки создают атмосферу — выбирай точные, а не общие\n\nСУБТЕКСТ И ИНТОНАЦИЯ:\n— Эмоция = действие или деталь, не слово: не «она была грустна» — а что она делает когда не знает что делать\n— Сильный глагол > прилагательное: «он перебирал пуговицы» > «он нервничал»\n\nСТОП-ЛИСТ ФИЗИОЛОГИЧЕСКИХ КЛИШЕ (запрещены в кульминационных сценах):\n— «сердце забилось быстрее / сердце ёкнуло / сердце ухнуло»\n— «холодный пот / испарина на лбу»\n— «мурашки по коже / мороз по коже»\n— «всё поплыло перед глазами / потемнело в глазах»\n— «ноги подкосились / земля ушла из-под ног»\nВместо них: конкретное действие, деталь, поведение тела без называния эмоции.\n\nСАМОПРОВЕРКА ПЕРЕД ОТПРАВКОЙ. Если ответ «НЕТ» — ПЕРЕПИСАТЬ это место:\n1. СРАВНЕНИЯ ЛОГИЧНЫ? Уточнение несёт смысл? Если нет — убери уточнение.\n2. ГЛАГОЛЫ ТОЧНЫ? Стрелу ПУСКАЮТ, меч ОБНАЖАЮТ, якорь БРОСАЮТ. Если неточный — заменить.\n3. ЯЗЫК СООТВЕТСТВУЕТ АУДИТОРИИ? Возраст до 14 — никакой наготы, физиологических подробностей. Если нарушено — переписать.\n\nВыдавай ТОЛЬКО готовую прозу — сразу первая строка, без вступлений.' },
...
// 10 техник открытия главы/книги — инжектируются по хэшу названия
const OPENING_STYLES=[
  'IN_MEDIAS_RES: Начни с середины действия — герой уже в ситуации. Не объясняй кто он и как сюда попал — читатель разберётся по ходу.',
  'DIALOGUE_FIRST: Первая строка — реплика диалога. Без представления говорящего, без «он сказал». Бросай читателя в разговор.',
  'SENSORY_HOOK: Открой с одной острой сенсорной детали — запах, звук, тактильное ощущение. Не место, не время — конкретное ощущение которое задаёт тон всей истории.',
  'INNER_THOUGHT: Первая строка — конкретная неожиданная мысль персонажа. Не «он думал о жизни», а что-то специфическое — деталь которая сразу показывает характер.',
  'PRECISE_MOMENT: Сверхточный момент — не «утром», а «в 7:23, когда последний автобус уже ушёл». Конкретность создаёт иллюзию реальности.',
  'WRONG_NOTE: Начни с обычной сцены, где одна маленькая деталь «не так». Читатель чувствует тревогу прежде чем понимает почему.',
  'CONSEQUENCE_FIRST: Начни с последствия события, которое ещё не произошло в тексте. «После той ночи он никогда больше не возвращался на улицу Ленина.» — и дальше рассказ как к этому дошло.',
  'OBJECT_AS_LENS: Конкретный предмет или место открывает сцену — через него сразу видны характер персонажа, его мир, его проблема.',
  'VERB_OPENER: Начни с глагола действия — персонаж что-то делает прямо сейчас. Без имени, без описания внешности, без «жил-был».',
  'IRONY_OPENER: Первое предложение — ироничное или парадоксальное утверждение. Читатель улыбается и хочет знать чем всё кончится.',
];
function pickOpeningStyle(title, genre){
  const key=(title||'')+(genre||'');
  return OPENING_STYLES[strHash(key)%OPENING_STYLES.length];
}
...
// logedit возвращает ===ТЕКСТ===...===КОНЕЦ=== — cleanProse гарантированно извлечёт прозу.
// Промт Логреда обязан использовать этот формат — без него он исключён из книги.
const BOOK_ROLES=new Set(['writer','line','logedit','proof','humanize','merge','fanout']);
...
function newBook(){
  ...
  // Переходим на мастер чтобы пользователь заполнил название и бриф
  switchView('simple');
...
// Состояние сортировки и фильтра библиотеки
let _blSort={col:'ts',dir:-1}; // col: title|genre|words|ts, dir: 1=asc -1=desc
let _blSearch='';
function openBookLibrary(){
  const allBooks=loadBooks();
  // Фильтрация по поиску
  let books=allBooks.filter(b=>{
    if(!_blSearch) return true;
    const q=_blSearch.toLowerCase();
    return (b.title||'').toLowerCase().includes(q)||(b.genre||'').toLowerCase().includes(q);
  });
  // Сортировка
  books=books.slice().sort((a,b)=>{
    let va,vb;
    if(_blSort.col==='title'){ va=(a.title||'').toLowerCase(); vb=(b.title||'').toLowerCase(); return _blSort.dir*(va<vb?-1:va>vb?1:0); }
    if(_blSort.col==='genre'){ va=(a.genre||'').toLowerCase(); vb=(b.genre||'').toLowerCase(); return _blSort.dir*(va<vb?-1:va>vb?1:0); }
    if(_blSort.col==='words'){ return _blSort.dir*((a.words||0)-(b.words||0)); }
    return _blSort.dir*((a.ts||0)-(b.ts||0)); // ts default
  });
  const arrow=col=>_blSort.col===col?(_blSort.dir===1?'↑':'↓'):'↕';
  const th=(col,label)=>`<th class="bl-th${_blSort.col===col?' bl-th-act':''}" data-bl-sort="${col}">${label}<span class="bl-arr">${arrow(col)}</span></th>`;
  let rows;
  if(!allBooks.length){
    rows=`<tr><td colspan="5" class="bl-empty-row">Библиотека пуста — сохраните текущую книгу или создайте новую.</td></tr>`;
  } else if(!books.length){
    rows=`<tr><td colspan="5" class="bl-empty-row">Ничего не найдено по запросу «${esc(_blSearch)}»</td></tr>`;
  } else {
    rows=books.map(b=>{
      const cur=(b.id===state._bookId);
      const dt=b.ts?new Date(b.ts).toLocaleDateString('ru-RU'):'—';
      const w=(b.words||0).toLocaleString('ru-RU');
      return `<tr class="bl-row${cur?' bl-cur-row':''}" data-book-id="${esc(b.id)}">
        <td class="bl-td bl-td-title">
          ${cur?'<span class="bl-cur-dot" title="Текущая">●</span>':''}
          <span class="bl-ttl">${esc(b.title||'Без названия')}</span>
        </td>
        <td class="bl-td bl-td-genre">${b.genre?`<span class="bl-tag">${esc(b.genre)}</span>`:''}</td>
        <td class="bl-td bl-td-words bl-num">${w}</td>
        <td class="bl-td bl-td-date bl-num">${esc(dt)}</td>
        <td class="bl-td bl-td-acts">
          <button class="btn ok xs" data-book-open="${esc(b.id)}"${cur?' disabled':''}>Открыть</button>
          <button class="btn ghost xs" data-book-dup="${esc(b.id)}" title="Дублировать">⧉</button>
          <button class="btn ghost xs bl-del-btn" data-book-del="${esc(b.id)}" title="Удалить">🗑</button>
        </td>
      </tr>`;
    }).join('');
  }
  openDrawer('📚 Мои книги',`
    <div class="bl-toolbar">
      <input class="bl-search" id="bl-search" placeholder="🔍 Поиск…" value="${esc(_blSearch)}">
      <div class="bl-toolbar-acts">
        <button class="btn ok sm" data-book-new>➕ Новая</button>
        <button class="btn ghost sm" data-book-save>💾 Сохранить текущую</button>
        <button class="btn ghost sm" id="bl-export-all">⬇ Экспорт</button>
        <label class="btn ghost sm">📥 Импорт<input type="file" id="bl-import-all" accept=".json" hidden></label>
      </div>
    </div>
    <div class="bl-count">${allBooks.length} ${allBooks.length===1?'книга':allBooks.length<5?'книги':'книг'}${_blSearch?' · найдено: '+books.length:''}</div>
    <div class="bl-table-wrap">
      <table class="bl-table">
        <thead><tr>
          ...
          ${th('words','Слов')}
          ${th('ts','Дата')}
          <th class="bl-th bl-th-acts">Действия</th>
        </tr></thead>
        <tbody>${rows}</tbody>
      </table>
    </div>`,
  b=>{
    // Поиск
    b.querySelector('#bl-search').oninput=e=>{ _blSearch=e.target.value; openBookLibrary(); };
    // Сортировка по клику на заголовок
    b.querySelectorAll('[data-bl-sort]').forEach(th=>th.onclick=()=>{
      const col=th.dataset.blSort;
      if(_blSort.col===col) _blSort.dir*=-1; else _blSort={col,dir:col==='ts'?-1:1};
      openBookLibrary();
    });
...
function openMoreMenu(){
  openDrawer('⋯ Инструменты',`
    <div class="mm-grid">
      <button class="mm-btn" data-action="concept">🧭 Замысел</button>
      <button class="mm-btn" data-action="switch-view" data-view="world">🌍 Мир</button>
      <button class="mm-btn" data-action="bible">📖 Библия</button>
      <button class="mm-btn" data-action="style-school">✍️ Стиль</button>
      <button class="mm-btn" data-action="series-manager">🔗 Серия</button>
      <button class="mm-btn" data-action="templates">🗂 Шаблоны</button>
      <button class="mm-btn" data-action="text-analysis">📊 Анализ</button>
      <button class="mm-btn" data-action="log">📋 Журнал</button>
      <button class="mm-btn" data-action="export">⬇ Экспорт</button>
      <button class="mm-btn" data-action="guide">? Гайд</button>
    </div>`);
}
...
function openSeriesManager(){
  ...
  if(curSeries){
    ...
    <div class="sm-world">
      ...
      <button class="btn ghost sm" id="sm-update-world-btn">🔄 Обновить Библию серии</button>
    </div>`;
  } else {
...
const GENRE_TONE_HINTS={
  // ── Сказки ──────────────────────────────────────────────────────────
  'сказ':    'Ты пишешь сказку. Лучшие сказки звучат как живая речь — напевно, просто, с повторами которые хочется слышать снова. Добро побеждает, но путь к победе интересен сам по себе. Мораль вырастает из истории, а не читается в конце.',
  'народн':  'Ты пишешь в духе народного эпоса. Торжественность и ритм — в самом языке. Персонажи говорят загадками. Мир большой, древний и немного опасный даже когда красивый.',
  // ── Фантастика ──────────────────────────────────────────────────────
  'фэнтези': 'Ты пишешь фэнтези. Лучшие фэнтези-миры ощущаются — их можно понюхать, услышать, потрогать. Магия работает как чудо, а не как механизм. Эпос и интимность чередуются.',
  'научн':   'Ты пишешь научную фантастику. Идеи раскрываются через судьбы людей, не через лекции. Технологии меняют поведение и отношения — покажи как. Лучшие вопросы остаются без ответа.',
  'фантаст': 'Ты пишешь фантастику. Фантастическое допущение логично внутри своих правил. Удивляй не только гаджетами — удивляй тем как человек на них реагирует.',
  // ── Напряжение ──────────────────────────────────────────────────────
  'детектив':'Ты пишешь детектив. Каждая деталь что-то значит — читатель перечитает финал и скажет «как я не заметил». Напряжение строится на недосказанности. Персонажи скрывают больше чем говорят.',
  'триллер': 'Ты пишешь триллер. Читатель всегда знает чуть меньше чем нужно — и это мучает. Темп меняется: длинное нагнетание → резкий удар. Угроза реальна только если иногда побеждает.',
  'ужас':    'Ты пишешь ужасы. Страшнее всего то чего не видно — звук, запах, тень краем глаза. Монстр страшнее пока не показан. Самые жуткие вещи — обыденные, вывернутые наизнанку.',
  // ── Романтика ───────────────────────────────────────────────────────
  'любов':   'Ты пишешь любовный роман. Электричество между персонажами важнее событий. Недопонимание и притяжение-отталкивание держат читателя. Читатель хочет чтобы они наконец-то...',
  'роман':   'Ты пишешь роман. Внутренняя жизнь персонажей — главное. Показывай через действие и деталь, а не через объяснение. Неоднозначность характеров делает историю живой.',
  // ── Реализм ─────────────────────────────────────────────────────────
  'современн':'Ты пишешь современную прозу. Психология важнее сюжета. Диалоги содержат больше молчания чем слов. Детали быта — не фон, а смысл.',
  'нон-фикш':'Ты пишешь нон-фикшн. Факты и идеи оживают через истории конкретных людей. Уважай время читателя — каждое предложение должно нести смысл.',
  // ── Детские ─────────────────────────────────────────────────────────
  'детск':   'Ты пишешь для детей. Дети не прощают скуки — каждая страница должна что-то менять. Герои действуют сами, без взрослых. Юмор настоящий, не снисходительный.',
  // ── Действие ────────────────────────────────────────────────────────
  'приключ': 'Ты пишешь приключенческую историю. Ритм — как горная дорога: подъём, спуск, неожиданный поворот. Мир яркий и телесный. Опасность настоящая.',
  // ── История ─────────────────────────────────────────────────────────
  'истори':  'Ты пишешь историческую прозу. Эпоха живёт в деталях — запахах, материалах, манере речи. Большая история — фон для маленькой человеческой драмы.',
  'биограф': 'Ты пишешь биографию или мемуары. Честность важнее красоты. Провалы и сомнения делают человека живым. Конкретный момент лучше общего рассуждения.',
  // ── Юмор ────────────────────────────────────────────────────────────
  'юмор':   'Ты пишешь юмористическую прозу. Комическое рождается из разрыва между ожиданием и реальностью. Абсурд работает когда логичен изнутри. Если шутку надо объяснять — её нет.',
};
...
function conceptBlock(){
  ...
  const pr=state.project||{};
  const bookTitle=(pr.title||'').trim();
  const bookBrief=(pr.brief||'').trim();
  let out='ЗАМЫСЕЛ КНИГИ (основа — развивай, не копируй механически):\n';
  if(bookTitle) out+=`Название: «${bookTitle}»\n`;
  if(bookBrief) out+=`О чём книга: ${bookBrief}\n`;
  if(setting) out+=`Место и время: ${setting}\n`;
  if(charsStr) out+=`Персонажи (живые детали — упоминай каждую max 1 раз, не делай их реквизитом):\n  ${charsStr}\n`;
...
async function buildMessages(n){
  ...
  const wr=['writer','line','fanout','beatsheet','humanize'].includes(roleKeyOf(n));
  let passportBlock='';
  if(wr){
    ...
    if(mix.length){
      ...
      passportBlock='\n\nСПЛАВ ГОЛОСОВ (вдохновляйся этими пропорциями, доминирует голос с наибольшим весом):\n'+lines+
      ...
      passportBlock='\n\nГОЛОС АВТОРА (пиши в этой манере — ритм, лексика, интонация — но своим сюжетом):\n'+pr.stylePassport + (pr.engagementPatterns?'\n\nПРИЁМЫ ВОВЛЕЧЕНИЯ (применяй):\n'+pr.engagementPatterns:'');
    }
  }
  ...
  // Очищаем вывод от служебных маркеров ===ТЕКСТ===...===КОНЕЦ=== перед передачей в контекст следующему агенту
  const _predClean=(p)=>{
    const rk=roleKeyOf(p);
    if(['logedit','line','proof'].includes(rk)) return cleanProse(p)||(p.summary||p.output);
    return p.summary||p.output;
  };
  // #44: словарь вывода предков по имени для {{prev.Имя}}
  const _prevByName={};
  predsWithOutput.forEach(p=>{ _prevByName[p.name]=smartTrunc(_predClean(p),perNode); });
  let prior=predsWithOutput.map(p=>`— ${p.name}:\n${smartTrunc(_predClean(p),perNode)}`).join('\n\n');
  ...
  const ctx={
    ...
    opening_style: pickOpeningStyle(pr.title, pr.genre),
    _prevByName
  };
  ...
  let user='';
  if(bible) user+=`Библия книги (имена, факты, мир — учитывай, не противоречь):\n${bible}\n\n`;
  ...
  if(state.chapterCtx){ const ch=state.chapterCtx;
    ...
    if(ch.targetWords && ['writer','fanout'].includes(rk))
      user+=`Целевой объём этой главы: ~${ch.targetWords} слов (${(CH_SIZES[ch.size]||CH_SIZES['md']).hint})\n`;
  ...
  const toneHint=(['writer','line','fanout'].includes(rk)&&genreToneHint())
    ? `\n\nДУХ ЖАНРА «${state.project.genre||''}»: ${genreToneHint()}`
    : '';
...
function render(){
  ...
  const _fpt=$('#proj-title'); if(_fpt) _fpt.value=state.project.title||'';
  const _fpg=$('#proj-genre'); if(_fpg) _fpg.value=state.project.genre||'';
  const _fpa=$('#proj-aud');   if(_fpa) _fpa.value=state.project.audience||'';
  const _fpb=$('#proj-brief'); if(_fpb) _fpb.value=state.project.brief||'';
  const _ecb=$('#proj-edit-mode'); if(_ecb) _ecb.checked=state.project.mode==='edit';
  // Индикатор ключа: dot + pill-текст + подсветка кнопки настроек
  const _noKey = !hasKey();
  const ks=$('#api-state');
  if(ks){
    ks.textContent = _noKey ? '⚠ нет ключа' : '';
    ks.style.display = _noKey ? '' : 'none';
    ks.classList.toggle('ok', !_noKey);
  }
  const _apiDot=$('#api-dot'); if(_apiDot) _apiDot.classList.toggle('ok', !_noKey);
  const _settingsBtn=$('#settings-btn'); if(_settingsBtn) _settingsBtn.classList.toggle('settings-warn', _noKey);
  ...
  if(rb){
    if(running){
      const _nd=state.nodes.filter(n=>n.status==='done'||n.status==='error'||n.status==='skip').length;
      const _nt=state.nodes.length;
      rb.textContent=_nt>1?`⏳ ${_nd}/${_nt}`:'⏳ Работает…';
    } else {
      rb.textContent=paused?'▶ Продолжить':'▶ Запустить';
    }
  }
...
function renderLeftRail(){
  const rail=document.querySelector('#lr-body'); if(!rail) return;
  const pr=state.project||{};
  const chapters=(typeof bookNodes==='function')?bookNodes():[];
  const activeTab=_lrTab||'struct';

  // ── Список глав (таб Структура) ──
  ...
  let chHtml;
  if(!chapters.length){
    chHtml='<div class="lr-empty">Нет глав.<br>Запустите пайплайн чтобы написать книгу.</div>';
  } else {
    chHtml=chapters.map((n,i)=>{
      ...
      const title=(typeof chapterTitleOf==='function')?chapterTitleOf(n,i):(n.name||('Гл.'+(i+1)));
      const active=(_panelNodeId===n.id)?' lr-ch-active':'';
      const hasOutput=!!(n.output&&n.output.trim());
      return '<div class="lr-ch-row'+active+'" data-id="'+n.id+'">'
        // Левая часть — кликабельна для навигации
        +'<div class="lr-ch-main" data-action="rail-chapter" data-id="'+n.id+'" title="'+esc(title)+'">'
        +'<span class="lr-ch-num">'+(i+1)+'</span>'
        +'<span class="lr-ch-ic '+scls+'">'+ic+'</span>'
        +'<span class="lr-ch-name">'+esc(title.slice(0,28))+(title.length>28?'…':'')+'</span>'
        +'</div>'
        // Правая часть — действия (появляются при hover)
        +'<div class="lr-ch-acts">'
        +(words?'<span class="lr-ch-wc">'+words.toLocaleString('ru-RU')+'</span>':'')
        +'<button class="lr-ch-btn" data-ch-rerun="'+n.id+'" title="Перезапустить эту главу">↺</button>'
        +(hasOutput?'<button class="lr-ch-btn" data-ch-read="'+n.id+'" title="Читать главу">👁</button>':'')
        +'</div>'
        +'</div>';
    }).join('');
  }
  ...
  // ── «В этой главе» ──
  let inChapterHtml='';
  const curNode=_panelNodeId?node(_panelNodeId):chapters[0];
  if(curNode&&curNode.output){
    const txt=curNode.output;
    const chars=(state.project.concept&&state.project.concept.characters)||[];
    const mentioned=chars.filter(p=>(p.name||p.role)&&txt.includes(p.name||p.role)).slice(0,5);
    const bibleKeys=(state.bible||[]).filter(b=>b.text&&txt.includes(b.keys.split(',')[0].trim())).slice(0,3);
    if(mentioned.length||bibleKeys.length){
      inChapterHtml='<div class="lr-sec-label" style="margin-top:12px">В этой главе</div>';
      mentioned.forEach(p=>{
        const nm=esc(p.name||p.role);
        inChapterHtml+='<div class="in-ch-item" data-action="concept" title="Открыть карточку персонажа">'
          +'<span class="in-ch-ic">👤</span><span class="in-ch-name">'+nm+'</span>'
          +'<span class="in-ch-role">'+esc((p.role||'').slice(0,20))+'</span>'
          +'</div>';
      });
      bibleKeys.forEach(b=>{
        const key=esc(b.keys.split(',')[0].trim());
        inChapterHtml+='<div class="in-ch-item" data-action="bible" title="Открыть в Библии">'
          +'<span class="in-ch-ic">📍</span><span class="in-ch-name">'+key+'</span>'
          +'</div>';
      });
    }
  }

  // ── Записи Библии (таб Библия) ──
  const bible=state.bible||[];
  let bibleHtml;
  if(!bible.length){
    bibleHtml='<div class="lr-empty">Библия пуста.<br><button class="btn ghost xs" data-action="bible" style="margin-top:8px">Открыть библию</button></div>';
  } else {
    bibleHtml=bible.slice(0,20).map(b=>'<div class="lr-bible-row"><span class="lr-bible-key">'+esc(b.keys.split(',')[0].trim())+'</span><span class="lr-bible-val">'+esc((b.text||'').slice(0,60))+'</span></div>').join('');
  }

  const styleLbl=(typeof activeStyleLabel==='function')?activeStyleLabel():'';

  rail.innerHTML=
    '<div class="lr-tabs">'
    +'<button class="lr-tab'+(activeTab==='struct'?' active':'') +'" data-lrtab="struct">Структура</button>'
    +'<button class="lr-tab'+(activeTab==='bible'?' active':'')+'" data-lrtab="bible">Библия</button>'
    +'</div>'
    +'<div class="lr-tab-body" id="lr-tab-struct" style="'+(activeTab==='struct'?'':'display:none') +'">'
    +  '<div class="lr-book-title">'+esc(pr.title||'Без названия')+'</div>'
    +  (styleLbl?'<div class="lr-style-badge" data-action="style-school" title="Активный стиль">✍️ '+esc(styleLbl)+' <span class="lr-style-x" data-action="clear-style">✕</span></div>':'')
    +  '<div class="lr-chapters">'+chHtml+'</div>'
    +  inChapterHtml
    +'</div>'
    +'<div class="lr-tab-body" id="lr-tab-bible" style="'+(activeTab==='bible'?'':'display:none')+'">'
    +  '<div class="lr-bible-list">'+bibleHtml+'</div>'
    +'</div>'
    +'<div class="lr-foot">'
    +'<button class="lr-nav-btn lr-nav-new" data-action="new-book">➕ Новая книга</button>'
    +'<button class="lr-nav-btn" data-action="book-library">📚 Мои книги</button>'
    +'</div>';

  // ── Обработчики кнопок глав ──
  rail.querySelectorAll('[data-ch-rerun]').forEach(btn=>{
    btn.onclick=(e)=>{ e.stopPropagation();
      const nd=node(btn.dataset.chRerun); if(!nd) return;
      nd.status='idle'; nd.output=''; nd.cacheHash='';
      save(); render(); runFromNode(btn.dataset.chRerun);
      toast('Перезапуск главы «'+nd.name+'»');
    };
  });
  rail.querySelectorAll('[data-ch-read]').forEach(btn=>{
    btn.onclick=(e)=>{ e.stopPropagation();
      _panelNodeId=btn.dataset.chRead;
      switchView('reader');
    };
  });
}
  ...
  el.innerHTML=`
    <div class="bi-overview">
      ...
      <div class="bi-actions">
        ...
        <button class="btn ghost sm" data-action="style-school">✍️ Стиль автора</button>
...
function renderNodes(){
  ...
  nodesEl.innerHTML=state.nodes.filter(n=>!collapsedIds.has(n.id)).map(n=>{
    ...
    const editBadge=(()=>{
      if(roleKeyOf(n)!=='logedit'||n.status!=='done'||!n.editSummary?.length) return '';
      const cnt=n.editSummary.length;
      const word=cnt===1?'правка':cnt<5?'правки':'правок';
      const items=n.editSummary.map(l=>`<div class="esum-item">${esc(l)}</div>`).join('');
      return `<div class="esum-wrap"><div class="esum-toggle" data-esum="${n.id}">📋 ${cnt} ${word} ▾</div><div class="esum-items" id="esum-${n.id}" style="display:none">${items}</div></div>`;
    })();
...
function portPos(id,side){ const n=node(id); if(!n) return {x:0,y:0}; return {x:n.x+(side==='out'?NW:0), y:n.y+PORT_Y+7}; }
...
function renderLoopCards(){
  ...
  state.edges.filter(e=>e.isLoop).forEach(e=>{
    ...
    `;
    const cv=document.getElementById('canvas'); if(!cv) return; cv.appendChild(card);
  });
}
...
function openNodePanel(id){
  ...
  const p=$('#node-panel'); if(!p) return;
  p.innerHTML=`
    <div class="np-head">
...
function closeNodePanel(){ const p=$('#node-panel'); if(!p) return; p.classList.remove('show'); p.setAttribute('aria-hidden','true'); _panelNodeId=null;
  nodesEl.querySelectorAll('.node.panel-active').forEach(el=>el.classList.remove('panel-active')); }
...
async function runNode(id){
  ...
  n.status='running'; n.output=''; n.error=''; n.editSummary=null; save(); renderNodes(); renderEdges();
  if(!abortCtrl) abortCtrl=new AbortController(); // fallback для одиночного прогона узла

  // ── Chunked editing для line/logedit/proof/humanize при длинном входящем тексте ────
  const _editRoles = ['line','logedit','proof','humanize'];
  if(_editRoles.includes(roleKeyOf(n))){
    ...
    if(_predText.length > 3000){
      ...
      try{
        ...
        n.lastRawOutput=acc;
        // Программная постобработка для logedit: вырезаем ВСЕ блоки анализа независимо от промта.
        // editInChunks обрабатывает текст по частям → каждая часть получает свой анализ.
        // Итог: чередование «анализ N» + «## Исправленный текст N» по всему тексту.
        // Глобальный стрип убирает ВСЕ пары за один проход.
        let _cleanedAcc=acc;
    ...
    try{
      let res=await fetch('/api/generate',{ method:'POST', headers:{'Content-Type':'application/json'},
        ...
        body:JSON.stringify({ baseURL:c.baseURL, apiKey:c.apiKey, model:c.model, temperature:c.temperature, proxyToken:state.global.proxyToken, messages:msgs,
          // для пишущих агентов повышаем лимит — иначе модель останавливается на ~700 токенах
          max_tokens: ['writer','line','logedit','proof','fanout'].includes(roleKeyOf(n)) ? 8000 : undefined }) });
      ...
      if(n.output&&n.output.trim()){
        ...
        const _vw=(n.output.match(/\S+/g)||[]).length;
        n.versions.push({ts:performance.now(),out:n.output.slice(0,50000),words:_vw});
        if(n.versions.length>8) n.versions=n.versions.slice(-8);
      }
      ...
      if(roleKeyOf(n)==='logedit' && n.output){
        const _sumMatch=n.output.match(/===\s*ПРАВКИ\s*===([\s\S]*?)===\s*ТЕКСТ\s*===/i);
        if(_sumMatch){
          const _lines=_sumMatch[1].trim().split('\n').map(l=>l.trim()).filter(l=>l&&l!=='Правок нет');
          if(_lines.length) n.editSummary=_lines;
        }
...
let running=false; let abortCtrl=null; let _pipelineStart=0;
let _lrTab='struct';
...
async function runPipeline(resume){
  ...
  if(!resume && state.nodes.length > 1 && state.edges.length === 0){
    toast('💡 Агенты не связаны — работают независимо. Добавьте рёбра в схеме или выберите шаблон через ⋯ → Шаблоны','warn');
  }
  if(!resume){
  ...
  running=true; const _rb1=$('#run-btn'); if(_rb1){ _rb1.disabled=true; _rb1.textContent='⏳ Работает…'; } render();
  ...
  while(true){
    ...
    { const _rb=$('#run-btn'); if(_rb){ const _nd=state.nodes.filter(n=>n.status==='done'||n.status==='error'||n.status==='skip').length; if(state.nodes.length>1) _rb.textContent=`⏳ ${_nd}/${state.nodes.length}`; } }
  ...
  running=false; const _rb2=$('#run-btn'); if(_rb2){ _rb2.disabled=false; } render();
...
async function runFromNode(id){
  ...
  save(); renderNodes(); renderEdges();
  abortCtrl=new AbortController();
  running=true; const _rb3=$('#run-btn'); if(_rb3){ _rb3.disabled=true; _rb3.textContent='⏳ Работает…'; } render();
  ...
  running=false; const _rb4=$('#run-btn'); if(_rb4){ _rb4.disabled=false; } render();
...
function openDrawer(title,html,mount){
  const dt=$('#drawer-title'); if(dt) dt.textContent=title;
  const b=$('#drawer-body'); if(!b) return; b.innerHTML=html;
  if(!drawer) return;
...
{ const _dc=$('#drawer-close'); if(_dc) _dc.onclick=closeDrawer; }
// Клик по оверлею вне модала — закрыть
...
function applyTheme(t){
  ...
  localStorage.setItem('izd_theme', t);
}
...
(()=>{ const saved=localStorage.getItem('izd_theme'); if(saved) applyTheme(saved); })();
// ─── Keyboard shortcuts ───
...
function openNode(id){
  ...
  openDrawer(`${n.emoji} ${esc(n.name)}`,`
    ...
    <div id="own-cfg" style="${n.useGlobal?'display:none':''}">
      <div class="field"><label>Адрес провайдера</label><input id="f-base" value="${esc(n.baseURL)}" placeholder="${esc(state.global.baseURL)}"></div>
    ...
    <div class="actions"><button class="btn ok" id="f-save">Сохранить</button>
      ...
      <button class="btn ghost" data-action="run-from" data-id="${n.id}">▶▶ Запустить отсюда</button>
...
function openSettings(){
  ...
  openDrawer('⚙ Настройки',`
    ...
    <div class="field"><label>Адрес провайдера</label><input id="g-base" value="${esc(g.baseURL)}"></div>
...
function openConcept(){
  ...
  const CARD_COLORS=['#6366f1','#f59e0b','#10b981','#f43f5e','#8b5cf6','#06b6d4'];
  const charCards=c.characters.map((p,i)=>{
    const accent=CARD_COLORS[i%CARD_COLORS.length];
    return `<div class="cc-card" data-ci="${i}" style="--cc-accent:${accent}">
      <div class="cc-card-head">
        <span class="cc-card-num">${i+1}</span>
        <input class="cc-name" value="${esc(p.name||'')}" placeholder="Имя персонажа">
        <input class="cc-age" value="${esc(p.age||'')}" placeholder="возраст">
        <button class="icon-btn cc-del-btn" data-delchar="${i}" title="Удалить персонажа">✕</button>
      </div>
      <div class="cc-card-body">
        <div class="cc-row2">
          <div class="cc-field"><label>Роль</label><input class="cc-role" value="${esc(p.role||'')}" placeholder="Протагонист / антагонист / наставник…"></div>
        </div>
        <div class="cc-field"><label>Характер и суть</label><textarea class="cc-brief cc-ta" rows="2" placeholder="Кто этот человек — 1-2 предложения">${esc(p.brief||'')}</textarea></div>
        <div class="cc-field cc-secret"><label>🔒 Что скрывает</label><textarea class="cc-hide cc-ta" rows="2" placeholder="Главная тайна — конкретный мотив, ложь, страх">${esc(p.secret||'')}</textarea></div>
        <div class="cc-field"><label>✨ Живая деталь</label><textarea class="cc-det cc-ta" rows="2" placeholder="Черта речи, реакция на стресс, деталь внешности — НЕ 'крутит предмет'">${esc(p.detail||'')}</textarea></div>
        <div class="cc-field"><label>🎯 Чего хочет</label><textarea class="cc-mot cc-ta" rows="2" placeholder="Главная цель в этой истории">${esc(p.motive||'')}</textarea></div>
      </div>
    </div>`;
  }).join('');
  openDrawer('🧭 Замысел',`
    <div class="cn-toolbar">
      <button class="btn ghost sm" id="cn-gen">🪄 Из брифа</button>
      <button class="btn ghost sm" id="cn-deepen">🎭 Углубить</button>
      <div style="flex:1"></div>
      <button class="btn ok sm" id="cn-save">💾 Сохранить</button>
      <button class="btn ghost sm" id="cn-clear">🗑</button>
    </div>
    <div class="cn-section">
      <div class="cn-section-label">🌍 Место и время действия</div>
      <textarea id="cn-setting" class="cn-ta" rows="3" placeholder="Где и когда происходит история. Две части для фантастики: обычный мир → особый мир">${esc(c.setting||'')}</textarea>
    </div>
    <div class="cn-section">
      <div class="cn-section-label">👤 Персонажи <span class="cn-chars-count">${c.characters.length}</span></div>
      <div id="concept-chars">${charCards||'<div class="cn-empty">Нет персонажей — нажмите ＋ или сгенерируйте из брифа</div>'}</div>
      <button class="btn ghost sm cn-add-btn" id="cn-addchar">＋ Добавить персонажа</button>
    </div>
    <div class="cn-section">
      <div class="cn-section-label">📍 Ключевые повороты сюжета</div>
      <textarea id="cn-plot" class="cn-ta" rows="5" placeholder="1. Завязка — что разрушает обычный мир&#10;2. Первое испытание&#10;3. Кризис / точка невозврата&#10;4. Кульминация&#10;5. Развязка">${esc(c.plotTurns||'')}</textarea>
    </div>
    <div class="cn-section cn-section-row">
      <div style="flex:1"><div class="cn-section-label">🎭 Тон / настроение</div>
      <input id="cn-tone" class="cn-input" value="${esc(c.tone||'')}" placeholder="Мрачный, ироничный, лирический, жёсткий…"></div>
    </div>
  `,b=>{
    const collect=()=>{
      ...
      c.characters=[...b.querySelectorAll('.cc-card')].map(r=>({
        ...
        brief:(r.querySelector('.cc-brief')?.value||r.querySelector('.cc-brief')?.textContent||'').trim(),
    ...
    // Авто-очистка «держит/крутит» клише в живых деталях при открытии
    const CLICHE=/крутит|теребит|держит в руках|постоянно трогает|всегда носит при себе|не расстаётся/i;
    b.querySelectorAll('.cc-det').forEach(ta=>{
      if(CLICHE.test(ta.value)){
        ta.style.borderColor='#f59e0b';
        ta.title='⚠ Клише «держит/крутит предмет» — замените на более оригинальную деталь';
      }
    });
...
async function generateConcept(silent){
  ...
  c.temperature=0.7;
  const isFiction=['фэнтези','детект','роман','триллер','ужас','сказ','приключ','фантаст'].some(g=>(pr.genre||'').toLowerCase().includes(g));
  const settingInstruction=isFiction
...
async function deepenCharacters(collectFn){
  ...
  const sys=`Ты — редактор-разработчик. Для каждого персонажа списка добавь недостающие поля. Верни СТРОГО JSON-массив: [{"name":"","age":"","role":"","brief":"","secret":"конкретная тайна — не банальность","detail":"ОДНА неожиданная деталь: черта речи, реакция на стресс, деталь внешности, специфическое поведение. ЗАПРЕЩЕНО клише 'всегда крутит/теребит/держит предмет'. Примеры: 'говорит тихо, но все замолкают', 'никогда не называет людей по имени', 'краснеет когда лжёт', 'у него нет тени левой руки на фото'","motive":"чего хочет в этой конкретной истории"}]. Только JSON-массив.`;
  ...
  container.innerHTML=`<div class="concept-eval">
    ...
    <div class="ce-axes">${result.axes.map(a=>`
      <div class="ce-axis">
        ...
        ${(a.score||5)<4&&a.tip?`<div class="ce-tip">💡 ${esc(a.tip)}</div>`:''}
        ${(a.score||5)<4?`<button class="btn ghost xs ce-improve" data-axis="${a.key}">✦ Улучшить</button>`:''}
      </div>`).join('')}
    </div>
...
function openExport(){
  openDrawer('⬇ Экспорт / импорт',`
    ...
    <div class="meta-form">
      ...
      <div class="actions"><button class="btn ghost" id="x-meta-fill">📋 Из агента «Метаданные»</button></div>
    </div>
    <div class="section-label">Схема пайплайна</div>
    <div class="actions"><button class="btn ghost" id="x-exp">⬇ Экспорт проекта (.json)</button>
      <button class="btn ghost" id="x-pipe">⬇ Экспорт пайплайна</button>
...
function cleanProse(n){
  const out=n.output||'';
  // Явные маркеры блока текста (оба)
  let m=out.match(/===\s*ТЕКСТ\s*===\s*([\s\S]*?)\s*===\s*КОНЕЦ\s*===/i);
  if(m) return m[1].trim();
  // Защита: ===ТЕКСТ=== есть, но ===КОНЕЦ=== отсутствует — берём всё после маркера
  m=out.match(/===\s*ТЕКСТ\s*===\s*([\s\S]+)/i);
  if(m) return m[1].replace(/===\s*КОНЕЦ\s*===/gi,'').trim();
  ...
  let s=out;
  // 1) однострочные редакторские преамбулы (литеральные, т.к. \w/\i не работают с кириллицей в JS без /u)
  s=s.replace(/^(?:Вот|вот|Ниже|ниже|Привожу|привожу|Готово|готово)\s[^\n]*\n+/,'');
  // 2) разделители --- и *** в начале
  s=s.replace(/^\s*(?:-{3,}|\*{3,})\s*\n+/,'');
  // 3) **Заголовок:** следующей строкой
  s=s.replace(/^\*{2}[^*\n]+\*{2}:?\s*\n+/,'');
  // 4) --- правки в конце
  s=s.replace(/\n+---\s*ПРАВКИ:[\s\S]*$/i,'');
  // 5) Вырезаем анализ Логреда если просочился: всё от «## Найденные противоречия» до «## Исправленный текст»
  //    (Логред иногда вставляет анализ несмотря на запрет — убираем машинно)
  s=s.replace(/\n+#{1,3}\s*Найденные\s+противоречия[\s\S]*?(?=\n#{1,3}\s*Исправленный|\n#{1,3}\s*Итоговый|$)/i,'');
  // 6) Убираем любые ## заголовки-секции редактора в середине текста (не главы книги)
  s=s.replace(/\n#{1,3}\s*(?:Найденные|Исправленный|Итоговый|Готовый|Замечания|Комментари)[^\n]*\n/gi,'\n');
  return s.trim();
}
...
document.addEventListener('click',e=>{
  const _lrTabEl=e.target.closest('[data-lrtab]');
  if(_lrTabEl){ _lrTab=_lrTabEl.dataset.lrtab; renderLeftRail(); return; }
  const _lrSec=e.target.closest('[data-lrsec]');
  if(_lrSec){
    const _sec=_lrSec.dataset.lrsec;
    const _bd=document.querySelector('#lrs-'+_sec+'-body');
    const _ar=document.querySelector('#lrs-'+_sec+'-arr');
    if(_bd){const _op=_bd.style.display==='none';_bd.style.display=_op?'':'none';if(_ar)_ar.textContent=_op?'▾':'▸';}
    return;
  }
  const _esumEl=e.target.closest('[data-esum]');
  if(_esumEl){ const _ep=document.getElementById('esum-'+_esumEl.dataset.esum); if(_ep){ const _open=_ep.style.display==='none'; _ep.style.display=_open?'block':'none'; _esumEl.textContent=_esumEl.textContent.replace(_open?'▾':'▸',_open?'▸':'▾'); } return; }
  const t=e.target.closest('[data-action]'); if(!t) return; const a=t.dataset.action,id=t.dataset.id;
  ...
  else if(a==='lrtab'||t.dataset.lrtab){ _lrTab=t.dataset.lrtab||a; renderLeftRail(); }
  else if(a==='zen-mode'){
    document.body.classList.toggle('zen-mode');
    const _zb=document.querySelector('#zen-btn');
    if(_zb) _zb.textContent=document.body.classList.contains('zen-mode')?'✕ Zen':'🧘';
  }
  ...
  else if(a==='more-menu') openMoreMenu();
  ...
  const _rpActEl=e.target.closest('[data-rpact]');
  if(_rpActEl&&hasKey()){
    const _rpAct=_rpActEl.dataset.rpact;
    const _curCh=bookNodes()[0];
    if(!_curCh||!_curCh.output){ toast('Нет текста для работы','warn'); return; }
    const _rpTxt=_curCh.output.slice(-2000);
    const _rpSys=_rpAct==='continue'?'Напиши продолжение этого текста — 150-200 слов. Только текст.':
      _rpAct==='twist'?'Предложи неожиданный сюжетный поворот для этой главы — 2-3 варианта кратко.':
      'Проанализируй главу: темп, слабые места, что улучшить. Кратко, по пунктам.';
    const _rpBtn=_rpActEl; _rpBtn.disabled=true; _rpBtn.textContent='⏳…';
    callLLM({baseURL:state.global.baseURL,apiKey:pickKey(),model:state.global.model,temperature:0.9},[
      {role:'system',content:_rpSys},
      {role:'user',content:_rpTxt}
    ]).then(function(r){
      openDrawer('✦ Соавтор',`<div class="rp-result">${esc(r)}</div>
        <button class="btn ok sm" onclick="navigator.clipboard?.writeText(document.querySelector('.rp-result').textContent);toast('Скопировано','ok')">📋 Скопировать</button>`);
    }).catch(function(e){ toast('Ошибка: '+e.message,'err'); })
    .finally(function(){
      _rpBtn.disabled=false;
      _rpBtn.textContent=_rpAct==='continue'?'→ Продолжить мысль':_rpAct==='twist'?'✦ Предложить поворот':'🗸 Проверить главу';
    });
    return;
  }
});
...
const GENRES = [
  {v:'fairy_tale',         l:'Сказки',                aud:'6–12',             tone:'простой, тёплый, волшебный — с троекратными повторами и моралью'},
  {v:'child_prose',        l:'Детская проза',         aud:'6–12',             tone:'простой, тёплый, поучительный'},
  {v:'romance_ya',         l:'Young Adult',           aud:'14–22',            tone:'энергичный, честный, о взрослении и первых выборах'},
  ...
  {v:'folklore',           l:'Народные сказания',     aud:'взрослые',         tone:'эпический, с архаичным языком и мифологическими образами'},
  {v:'biography',          l:'Биография / Мемуары',   aud:'взрослые',         tone:'личный, рефлексивный, честный'},
...
const PROJECT_TPLS = {
  ...
  story:{ label:'📖 Рассказ', icon:'📖', roles:['writer','audit','logedit','proof'], loops:[], brief:'Короткий рассказ' },
  nonfic:{ label:'📚 Нон-фикшн', icon:'📚', roles:['dev','writer','factcheck','meta'], loops:[], brief:'Книга на основе экспертизы автора' },
  // novel: убраны scout, factcheck, art, layout, mkt; audit+logedit перед line
  novel:{ label:'✍️ Роман', icon:'✍️', roles:['dev','writer','audit','logedit','line','proof','continuity','meta'], loops:[], brief:'Полный производственный цикл' },
  ...
  qualityloop:{ label:'🔁 Редактура до качества', icon:'🔁',
    roles:['dev','writer','audit','logedit','proof'],
    // 0=dev,1=writer,2=audit,3=logedit,4=proof
    loops:[ {from:3,to:1,base:8,name:'Логред → доработка'}, {from:4,to:3,base:9,name:'Корректор → доработка'} ],
    brief:'Логред и корректор возвращают текст на доработку, пока оценка не достигнет порога' },
  // house: убраны scout и factcheck (художественный цикл); audit+logedit перед line
  // roles indices: 0=dev,1=writer,2=continuity,3=audit,4=logedit,5=line,6=proof,7=meta
  house:{ label:'🏛 Издательство — полный цикл', icon:'🏛',
    roles:['dev','writer','continuity','audit','logedit','line','proof','meta'],
    loops:[ {from:4,to:1,base:8,name:'Логред → автор'}, {from:5,to:1,base:8,name:'Литред → автор'}, {from:6,to:5,base:9,name:'Корректор → литред'} ],
    brief:'Производственный цикл как в издательстве: автор → аудит противоречий, литредактуры и корректуры с возвратами на доработку' },
...
let _wizGenerating = false; // идёт асинхронная генерация замысла
...
function collectWizStep1(){
  const title=document.querySelector('#simp-title')?.value.trim();
  if(title) state.project.title=title;
  const brief=document.querySelector('#simp-brief')?.value.trim();
  if(brief) state.project.brief=brief;
  state.project.genre=document.querySelector('#simp-genre')?.value||state.project.genre;
  state.project.audience=(document.querySelector('#simp-aud')?.value||'').trim()||state.project.audience;
  state.project.sourceText=(document.querySelector('#simp-source')?.value||'').trim()||state.project.sourceText;
  state.project.charManual=!!document.getElementById('simp-char-manual')?.checked;
  const _cmin=parseInt(document.querySelector('#simp-char-min')?.value||'0',10);
  const _cmax=parseInt(document.querySelector('#simp-char-max')?.value||'0',10);
  if(_cmin) state.project.charMin=Math.max(1,Math.min(10,_cmin));
  if(_cmax) state.project.charMax=Math.max(state.project.charMin,Math.min(15,_cmax));
  save();
}

function initSimplifiedMode(){
  closeDrawer(); // закрыть любой открытый ящик при входе в мастер
  document.querySelectorAll('.wiz-type-card').forEach(function(c){
    c.onclick=function(){
      document.querySelectorAll('.wiz-type-card').forEach(function(x){x.classList.remove('active');});
      c.classList.add('active');
      var t=c.dataset.wtype;
      var srcWrap=document.querySelector('#wiz-src-wrap');
      if(srcWrap) srcWrap.style.display=(t==='adaptation')?'':'none';
      var brief=document.querySelector('#simp-brief');
      if(brief){
        if(t==='nonfiction') brief.placeholder='Главная идея книги, кому поможет, какую проблему читателя решает';
        else if(t==='adaptation') brief.placeholder='Кратко о чём исходный материал (опционально)';
        else brief.placeholder='Кто главный герой, в чём конфликт, что происходит. Чем подробнее — тем лучше.';
      }
    };
  });
  ...
  if(next1) next1.onclick=async()=>{
    ...
    _wizGenerating = false;
    renderWizConcept();
  };

  // ── Шаг 2: показ и редактирование замысла ──────
  // ── Список глав wizard ──────────────────────────
  // Используем onclick= (не addEventListener) — исключает стакирование при повторных вызовах initSimplifiedMode
  const _chAdd=document.getElementById('wiz-ch-add');
  if(_chAdd) _chAdd.onclick=()=>{
  ...
  const _back1=document.querySelector('#wiz-back-1');
  if(_back1) _back1.onclick=()=>{ collectWizStep1(); wizGoStep(1); };
  const _regen=document.querySelector('#wiz-regen');
  if(_regen) _regen.onclick=async()=>{
    const body=document.querySelector('#wiz-concept-body');
    if(body) body.innerHTML='<div class="lr-empty" style="display:flex;flex-direction:column;align-items:center;gap:10px;padding:24px 0"><span class="thinking"><span></span><span></span><span></span></span><span id="wiz-gen-status" style="color:var(--dim);font-size:.9rem">Генерирую замысел…</span></div>';
    state.project.concept={setting:'',characters:[],plotTurns:'',tone:''};
    _wizGenerating = true;
  ...
  if(next2) next2.onclick=()=>{
    // collectWizConcept больше не нужен — данные сохраняются через openConcept()
  ...
  // Восстановить шаг — не сбрасывать если идёт генерация или уже есть замысел
  if(_wizGenerating){
    // Генерация идёт — показываем шаг 2 и выходим, чтобы не перезаписывать DOM и хэндлеры
    wizGoStep(2);
    const _wb=document.querySelector('#wiz-concept-body');
    if(_wb && !_wb.querySelector('.thinking')){
      // Спиннер пропал (пользователь переключал вкладки) — восстанавливаем
      _wb.innerHTML='<div class="lr-empty" style="display:flex;flex-direction:column;align-items:center;gap:10px;padding:24px 0"><span class="thinking"><span></span><span></span><span></span></span><span id="wiz-gen-status" style="color:var(--dim);font-size:.9rem">Генерирую замысел…</span></div>';
    }
    return; // выходим — не нужно перерегистрировать обработчики или перезаполнять поля
  }
  const _cc=state.project.concept||{};
  const _hasConc=!!((_cc.plotTurns)||(_cc.characters||[]).length||_cc.setting);
  // _wizStep мог сброситься в 1 после перезагрузки страницы, но концепт есть → идём на 2
  wizGoStep(_hasConc ? Math.max(2, _wizStep) : 1);
  // Если концепт есть, но DOM #wiz-concept-body пустой — отрендерим
  if(_hasConc){
    const _cb=document.querySelector('#wiz-concept-body');
    if(_cb && !_cb.querySelector('.wiz-concept-summary')) renderWizConcept();
  }
...
function renderWizConcept(){
  ...
  _wizGenerating = false; // генерация завершена в любом случае
  // Если пользователь ушёл во время генерации и оказался на шаге 1 — вернуть на 2
  if(_wizStep < 2) wizGoStep(2);
  const c=state.project.concept||{};
  const chars=(c.characters||[]);
  const setting=(c.setting||'').trim();
  const plotTurns=(c.plotTurns||'').trim();
  const tone=(c.tone||'').trim();
  const hasContent=setting||plotTurns||chars.length;

  if(!hasContent){
    body.innerHTML=`<div class="wiz-concept-empty">⏳ Замысел ещё не создан — нажмите «🔄 Перегенерировать» или заполните вручную через кнопку ниже.</div>`;
  } else {
    const charChips=chars.map(p=>`<span class="wc-chip">${esc(p.name||p.role||'?')}</span>`).join('');
    const plotPreview=plotTurns.split('\n').filter(Boolean).slice(0,3).map(l=>{const t=l.replace(/^\d+\.\s*/,'');return`<div class="wc-turn">• ${esc(t.length>120?t.slice(0,120)+'…':t)}</div>`;}).join('');
    body.innerHTML=`
      <div class="wiz-concept-summary">
        ${setting?`<div class="wcs-row"><span class="wcs-label">🌍 Место</span><span class="wcs-val">${esc(setting.slice(0,160))}</span></div>`:''}
        ${chars.length?`<div class="wcs-row"><span class="wcs-label">👤 Персонажи</span><div class="wc-chips">${charChips}</div></div>`:''}
...
function roleToHumanLabel(roleKey, status){
  const DONE={
    writer:'Глава написана',fanout:'Глава написана',line:'Стиль отполирован',
    proof:'Текст вычитан',audit:'Логика проверена',logedit:'Ошибки исправлены',
    humanize:'Шаблонность убрана',distill:'Контекст сжат',beatsheet:'Структура готова',
    dev:'Композиция разобрана',scout:'Рукопись оценена',continuity:'Канон проверен',
    factcheck:'Факты проверены',meta:'Метаданные готовы',mkt:'Маркетинг готов',
    art:'Бриф обложки готов',layout:'Вёрстка готова'
  };
  const RUN={
    writer:'Пишу главу…',fanout:'Пишу главу…',line:'Полирую стиль…',
    proof:'Вычитываю текст…',audit:'Проверяю логику сюжета…',logedit:'Исправляю найденные ошибки…',
    humanize:'Убираю шаблонность…',distill:'Сжимаю контекст…',beatsheet:'Строю структуру…',
    dev:'Анализирую композицию…',scout:'Оцениваю рукопись…',continuity:'Проверяю канон…',
    factcheck:'Проверяю факты…',meta:'Готовлю метаданные…',mkt:'Планирую маркетинг…',
    art:'Готовлю бриф обложки…',layout:'Верстаю…'
  };
  if(status==='done') return DONE[roleKey]||'Готово';
  if(status==='running'||status==='review'||status==='variants') return RUN[roleKey]||'Работаю…';
  if(status==='error') return 'Ошибка';
  if(status==='skip') return 'Пропущено';
  return RUN[roleKey]||'Ожидание…';
}
...
function renderSimpleProgress(){
  ...
  const rows=nodes.map(n=>{
    ...
    const rk=roleKeyOf(n);
    const label=roleToHumanLabel(rk,n.status);
    return `<div class="sp-row ${cls}"><span class="sp-ic">${ic}</span><span class="sp-name">${esc(label)}</span></div>`;
  }).join('');
  const _elMs=_pipelineStart?(performance.now()-_pipelineStart):0;
  const _elStr=_elMs>60000?Math.round(_elMs/60000)+' мин':Math.round(_elMs/1000)+' сек';
  const _titleEl=document.getElementById('wiz-running-title');
  if(_titleEl) _titleEl.textContent=finished?'Книга готова! 📖':running?'Команда агентов пишет книгу…':'Прогресс создания книги';
  const _wc=finished?_bookWords():0;
  const _wcStr=_wc>0?` · ~${Math.round(_wc/250)} стр. · ${_wc.toLocaleString('ru-RU')} слов`:'';
  const head=finished
    ? `<div class="sp-head">📖 Книга готова${_wcStr} · ${_elStr}</div>`
    : running
      ? `<div class="sp-head">✨ Команда агентов создаёт книгу… ${pct}% · прошло ${_elStr}</div>`
  ...
  if(running){
    ...
    foot=`<button class="btn ok sm" id="sp-read" type="button">📖 Читать</button>
      ...
      <button class="btn primary sm" id="sp-new-book" type="button">➕ Новая книга</button>
      <a href="#" class="sp-link" id="sp-show-canvas">Показать на схеме →</a>`;
  } else {
  ...
  box.querySelector('#sp-new-book')?.addEventListener('click',()=>{ newBook(); });
}
...
function openStyleSchool(activeTab){
  ...
  const createPane=`
    ...
    <div class="field"><label>…или вставьте образец текста вручную</label>
      <textarea id="ss-text" rows="9" placeholder="Вставьте 1 000–15 000 символов текста — сказку Пушкина, главу Толстого, свои черновики…"></textarea>
      <div class="ss-char-counter" id="ss-char-counter"><span id="ss-char-n">0</span> символов &nbsp;·&nbsp; <span class="ss-char-hint" id="ss-char-hint">оптимально: 1 000–15 000</span></div>
    </div>
    <div class="field"><label>Название стиля</label>
      <input id="ss-name" placeholder="напр. Пушкин — сказки, Хемингуэй, мой голос…"></div>
  ...
  const libCards=lib.length ? lib.slice().reverse().map(e=>{
    const preview=(s,n)=>{ const t=(s||'').trim(); return t.length>n?t.slice(0,n)+'…':t; };
    const isActive=(state.project.styleMix||[]).some(m=>m.id===e.id);
    return `<div class="ss-card${isActive?' ss-card-active':''}" data-id="${e.id}">
      <div class="ss-card-head">
        <strong>${esc(e.name||'без названия')}</strong>${isActive?'<span class="ss-active-badge">✓ активен</span>':''}
        <span class="ss-card-meta">${fmtDate(e.ts)}</span>
      </div>
      <div class="ss-preview-line">🎭 ${esc(preview(e.style,120))}</div>
      <details class="ss-det"><summary>Паспорт стиля (полностью)</summary><div class="ss-det-body">${esc(e.style||'—')}</div></details>
      ...
      <div class="ss-card-actions">
        <button class="btn ghost mini" data-preview="${e.id}">📝 Пробный абзац</button>
  ...
  }).join('') : `<div class="ss-empty">Библиотека пуста.<br>Перейдите во вкладку <b>Создать</b> и загрузите фрагмент любимого текста.</div>`;
  ...
  const mixPane=`
    ...
    <div id="ss-mix-confirm" class="ss-mix-confirm" style="display:none"></div>
    <div class="actions">
      <button class="btn ok" id="ss-mix-apply">✅ Применить микс</button>
      <button class="btn ghost" id="ss-mix-fuse" ${lib.length<2?'disabled title="Добавьте ещё стилей в библиотеку"':''}>🔥 Сплавить в один стиль</button>
    </div>`;

  openDrawer('✍️ Стиль автора', `
    <p class="ss-tagline">Загрузите образец → агенты пишут в этом голосе</p>
    <div class="set-tabs">
  ...
  `, b=>{
    ...
    const charN=b.querySelector('#ss-char-n');
    const charHint=b.querySelector('#ss-char-hint');
    const updateCounter=()=>{
      if(!charN||!charHint) return;
      const n=(ta.value||'').length;
      charN.textContent=n.toLocaleString('ru-RU');
      charN.style.color = n<500?'var(--warn)': n<=15000?'var(--ok)':'var(--accent)';
      charHint.textContent = n<500?'мало — добавьте больше текста':
        n<=15000?'отлично для анализа':
        'большой текст — будет сделана равномерная выборка';
    };
    if(ta){ ta.addEventListener('input',updateCounter); updateCounter(); }
    ...
    // ── Библиотека ──
    b.querySelectorAll('[data-preview]').forEach(btn=>btn.onclick=async()=>{
      ...
      try{
        const sys=`${e.style||''}\n\n${e.engagement||''}`.slice(0,1800);
        const c={ baseURL:state.global.baseURL, apiKey:pickKey(), model:state.global.model, temperature:0.9 };
        const result=await callLLM(c,[
          {role:'system',content:'Ты — писатель. Следуй паспорту стиля СТРОГО:\n\n'+sys+'\n\nПиши ТОЛЬКО своим сюжетом — НЕ копируй источник.'},
          {role:'user',content:'Напиши 150–200 слов: человек идёт по улице дождливым вечером. Только текст, без заголовка.'}
        ]);
        // Вставляем результат прямо под карточкой
        let previewBox=btn.closest('.ss-card').querySelector('.ss-trial-box');
        if(!previewBox){
          previewBox=document.createElement('div');
          previewBox.className='ss-trial-box';
          btn.closest('.ss-card-actions').before(previewBox);
        }
        previewBox.innerHTML=`<div class="ss-trial-label">📝 Пробный абзац в стиле «${esc(e.name)}»:</div><div class="ss-trial-text">${esc(result)}</div>`;
      }catch(err){ toast('Ошибка: '+err.message,'err'); }
      finally{ btn.disabled=false; btn.textContent='📝 Пробный абзац'; }
    });
    ...
    const refreshSum=()=>{
      ...
      // Динамически блокируем «Сплавить» если меньше 2 стилей выбрано
      const fuseBtn2=b.querySelector('#ss-mix-fuse');
      if(fuseBtn2) fuseBtn2.disabled=sel.length<2;
    };
    rows().forEach(r=>{
    ...
    const confirmEl=b.querySelector('#ss-mix-confirm');
    if(applyBtn) applyBtn.onclick=()=>{
      const m=collectMix();
      if(!m.length){ toast('Выберите хотя бы один стиль','warn'); return; }
      if(m.length>3){ toast('Максимум 3 стиля','warn'); return; }
      state.project.styleMix=m; save(); render();
      // Inline-подтверждение вместо исчезающего тоста
      const names=m.map(mx=>{
        const e=(state.styleLibrary||[]).find(x=>x.id===mx.id);
        return e?(e.name+(m.length>1?` (${mx.weight}%)`:'')):mx.id;
      }).join(' + ');
      if(confirmEl){
        confirmEl.style.display='';
        confirmEl.innerHTML=`✅ <b>Стиль активен: «${esc(names)}»</b><br><span class="ss-confirm-sub">Агенты Писатель и Литред пишут в этом голосе. Запустите пайплайн чтобы увидеть результат.</span>`;
      }
      toast('✍️ Стиль «'+names+'» активен','ok');
    };
...
/* ============ ГЛАВА-ЗА-ГЛАВОЙ ============ */
// Объём главы: ключ → слова (целевое)
const CH_SIZES={
  'xs':{ label:'Мини',   words:400,  hint:'~400 слов — переходная сцена, пролог, эпилог' },
  'sm':{ label:'Короткая', words:900, hint:'~900 слов — быстрая сцена, развязка' },
  'md':{ label:'Обычная',words:1800, hint:'~1800 слов — стандартная глава' },
  'lg':{ label:'Длинная', words:2800, hint:'~2800 слов — важная глава с несколькими сценами' },
  'xl':{ label:'Кульминация', words:4500, hint:'~4500 слов — финальная битва, главный поворот' },
};
function chSizeWords(ch){ return (CH_SIZES[ch.size]||CH_SIZES['md']).words; }

function openChapters(){
  const chs=state.chapters||[];
  const bookDone=(state.chapterBook||[]).length;
  const totalWords=chs.reduce((s,ch)=>s+chSizeWords(ch),0);

  const rows=chs.length ? chs.map((ch,i)=>{
    const size=ch.size||'md';
    const sizeOpts=Object.entries(CH_SIZES).map(([k,v])=>
      `<option value="${k}" ${k===size?'selected':''}>${v.label}</option>`).join('');
    const done=(state.chapterBook||[]).find(r=>r.chapterId===ch.id);
    const doneWords=done?Object.values(done.outputs).reduce((s,o)=>{
      const rk=Object.values(done.outputs).indexOf(o);
      return s+(o.output||'').split(/\s+/).length;
    },0):0;
    return `<div class="ch-row" data-chid="${ch.id}">
      <div class="ch-row-num">${i+1}</div>
      <div class="ch-row-main">
        <div class="ch-row-top">
          <input class="ch-title-in" value="${esc(ch.title)}" placeholder="Название главы ${i+1}">
          <select class="ch-size-sel" title="${CH_SIZES[size].hint}">
            ${sizeOpts}
          </select>
          <button class="icon-btn ch-del-btn" data-delch="${ch.id}" title="Удалить главу">✕</button>
        </div>
        <textarea class="ch-brief-ta" rows="2" placeholder="О чём эта глава — что происходит, какой поворот, чем заканчивается">${esc(ch.brief||'')}</textarea>
        ${done?`<div class="ch-done-badge">✅ готова · ~${chSizeWords(ch).toLocaleString('ru-RU')} слов</div>`:''}
      </div>
    </div>`;
  }).join('')
  : `<div class="ch-empty">Глав нет. Нажмите <b>＋ Добавить главу</b> или <b>🪄 Из замысла</b> — система сама составит структуру.</div>`;

  openDrawer('📚 Главы книги', `
    <div class="ch-how">
      <div class="ch-how-step"><span class="ch-how-n">1</span>Составьте список глав с кратким содержанием</div>
      <span class="ch-how-arr">→</span>
      <div class="ch-how-step"><span class="ch-how-n">2</span>Выберите объём каждой главы</div>
      <span class="ch-how-arr">→</span>
      <div class="ch-how-step"><span class="ch-how-n">3</span>Нажмите ▶ — пайплайн пишет главы одну за другой</div>
    </div>
    <p class="ch-note">Контекст (что произошло в предыдущих главах) передаётся следующей главе автоматически. Библия обновляется после каждой главы.</p>
    <div class="ch-toolbar">
      <button class="btn ghost sm" id="ch-add">＋ Добавить главу</button>
      <button class="btn ghost sm" id="ch-from-concept">🪄 Из замысла</button>
      <div style="flex:1"></div>
      <button class="btn ghost sm" id="ch-save">💾 Сохранить</button>
    </div>
    <div id="ch-list">${rows}</div>
    ${chs.length?`<div class="ch-total">Итого: <b>${chs.length} ${chs.length===1?'глава':chs.length<5?'главы':'глав'}</b> · примерно <b>~${totalWords.toLocaleString('ru-RU')} слов</b></div>`:''}
    ${bookDone?`<div class="ch-done-section">
      <div class="ch-done-header">✅ Готово: ${bookDone} из ${chs.length} глав</div>
      <div class="ch-done-list">${(state.chapterBook||[]).map(c=>`<span class="ch-done-pill">${c.num}. ${esc(c.title)}</span>`).join('')}</div>
      <div class="ch-done-actions">
        <button class="btn ok sm" id="ch-export">📕 Скачать всю книгу (.md)</button>
        <button class="btn danger sm" id="ch-clear">🗑 Очистить результаты</button>
      </div>
    </div>`:''}
    <div class="ch-run-row">
      <button class="btn primary lg" id="ch-run" ${chs.length?'':'disabled'}>▶ Запустить все главы</button>
    </div>
  `,b=>{
    const collectAll=()=>{
      b.querySelectorAll('[data-chid]').forEach(r=>{
        const ch=(state.chapters||[]).find(x=>x.id===r.dataset.chid); if(!ch) return;
        ch.title=r.querySelector('.ch-title-in')?.value.trim()||ch.title;
        ch.brief=r.querySelector('.ch-brief-ta')?.value.trim()||'';
        ch.size=r.querySelector('.ch-size-sel')?.value||'md';
      });
    };
    b.querySelector('#ch-add').onclick=()=>{
      collectAll(); if(!state.chapters) state.chapters=[];
      state.chapters.push({id:uid(),title:'Глава '+(state.chapters.length+1),brief:'',size:'md'});
      save(); openChapters();
    };
    b.querySelector('#ch-save').onclick=()=>{ collectAll(); save(); toast('Главы сохранены','ok'); };
    b.querySelectorAll('[data-delch]').forEach(x=>x.onclick=()=>{
      collectAll(); state.chapters=state.chapters.filter(c=>c.id!==x.dataset.delch); save(); openChapters();
    });
    b.querySelector('#ch-from-concept').onclick=async()=>{
      const pt=(state.project.concept?.plotTurns||'').trim();
      const brief=state.project.brief||'';
      if(!pt && !brief){ toast('Заполните Замысел или Бриф — из них строится план','warn'); return; }
      if(!hasKey()){ toast('Нужен API-ключ','err'); return; }
      const btn=b.querySelector('#ch-from-concept'); btn.disabled=true; btn.textContent='⏳…';
      try{
        const c=cfg({useGlobal:true}); c.temperature=0.4;
        const src=pt?`Повороты сюжета:\n${pt}`:`Бриф: ${brief}`;
        const r=await callLLM(c,[
          {role:'system',content:'Составь план глав книги. Верни СТРОГО JSON-массив: [{"title":"...","brief":"...","size":"md"}]. size: xs=400сл, sm=900сл, md=1800сл, lg=2800сл, xl=4500сл. 5-12 глав. Только JSON.'},
          {role:'user',content:src}
        ]);
        let txt=r.trim(); const m=txt.match(/```(?:json)?\s*([\s\S]*?)```/i); if(m) txt=m[1];
        const arr=JSON.parse(txt.slice(txt.indexOf('['),txt.lastIndexOf(']')+1));
        if(!Array.isArray(arr)||!arr.length) throw new Error('не массив');
        state.chapters=arr.map(x=>({id:uid(),title:String(x.title||'').trim()||'Глава',brief:String(x.brief||'').trim(),size:CH_SIZES[x.size]?x.size:'md'}));
        save(); toast('План глав сгенерирован ✓','ok'); openChapters();
      }catch(e){ toast('Ошибка: '+e.message.slice(0,60),'err'); btn.disabled=false; btn.textContent='🪄 Из замысла'; }
    };
    if(bookDone){
      b.querySelector('#ch-export')?.addEventListener('click',exportChapterBook);
      b.querySelector('#ch-clear')?.addEventListener('click',()=>{ state.chapterBook=[]; save(); openChapters(); });
    }
    b.querySelector('#ch-run').onclick=()=>{ collectAll(); save(); closeDrawer(); runChapterMode(); };
  });
}
async function runChapterMode(){
  ...
  for(let i=0;i<chs.length;i++){
    ...
    state.chapterCtx={num:i+1,title:ch.title,brief:ch.brief||'',size:ch.size||'md',targetWords:chSizeWords(ch),prevSummary:prevSummaries.slice(-3).join('\n')};
    save(); render();
    runPipeline(false);
...
function renderStageView(){
  ...
  // Авто-переключение на первую непустую стадию
  if(!_svNodesIn(_svStage).length){const _fs=SV_STAGES.find(s=>_svNodesIn(s.key).length);if(_fs)_svStage=_fs.key;}
...
function updateCoAuthorHints(){
  const panel=document.querySelector('#rp-hints'); if(!panel) return;
  if(_currentView!=='reader'){ panel.innerHTML=''; return; }
  const chapters=bookNodes();
  const curNode=_panelNodeId?node(_panelNodeId):chapters[0];
  const hints=[];
  ...
  if(curNode&&curNode.output){
    ...
    // Подсказки из Библии: факты которые стоит упомянуть
    (state.bible||[]).slice(0,30).forEach(function(b){
      const key=b.keys.split(',')[0].trim();
      if(key&&txt.includes(key)){
        hints.push({type:'hint', text:key+': '+b.text.slice(0,80)+'…'});
      }
    });

    // Противоречия: персонаж упомянут под другим именем/ролью в других главах
    chars.forEach(function(p){
      if(!p.name) return;
      const altName=p.role&&p.role!==p.name?p.role:'';
      if(altName&&txt.includes(p.name)){
        const prevChapter=chapters.find(function(ch){ return ch!==curNode&&ch.output&&ch.output.includes(altName); });
        if(prevChapter){
          hints.push({type:'warn', text:'«'+p.name+'» и «'+altName+'» — одно лицо, но используются оба варианта'});
        }
      }
    });
  }
  ...
  if(!hints.length){
    panel.innerHTML='<div class="rp-empty">Всё в порядке.<br>Продолжайте писать 👍</div>';
  } else {
    panel.innerHTML=hints.slice(0,5).map(function(h){
      return '<div class="rp-hint rp-hint-'+h.type+'"><div class="rph-text">'+esc(h.text)+'</div></div>';
    }).join('');
  }
}
...
function renderReader(){
  ...
  if(!order.length){
    ...
    // 3-Act visual bar
    const _tChs=order.length;
    if(_tChs>=3){
      const _chBlocks=order.map((n,i)=>{
        const _pos=_tChs>1?Math.round(i/(_tChs-1)*100):50;
        const _t=esc(chapterTitleOf(n,i));
        const _w=((n.output||'').match(/\S+/g)||[]).length;
        return '<div class="act-ch" style="left:'+_pos+'%" title="'+_t+' (~'+_w.toLocaleString('ru-RU')+' слов)"><div class="act-ch-dot"></div><div class="act-ch-lbl">'+_t.slice(0,16)+'</div></div>';
      }).join('');
      html+='<div class="act-bar-wrap"><div class="act-bar-label">Структура книги (3 акта)</div><div class="act-bar"><div class="act-seg" style="width:25%;background:#6366f1" title="Акт 1 — Завязка"><span>Акт 1</span></div><div class="act-seg" style="width:50%;background:#f59e0b" title="Акт 2 — Развитие"><span>Акт 2</span></div><div class="act-seg" style="width:25%;background:#ef4444" title="Акт 3 — Развязка"><span>Акт 3</span></div><div class="act-chapters">'+_chBlocks+'</div></div></div>';
    }
    ...
    order.forEach((n,i)=>{
      ...
      const _hasVer=Array.isArray(n.versions)&&n.versions.length>1;
      const _vBtn=_hasVer?'<button class="btn ghost xs rver-btn" data-nid="'+n.id+'" style="margin-left:6px">⏱ '+n.versions.length+' версий</button>':'';
      const head=showAll
        ...
        : `<div>
            ...
            <div style="font-size:11px;color:var(--faint)">~${words.toLocaleString('ru-RU')} слов${_vBtn}</div>
          </div>`;
      html+=`<div id="reader-ch${i}" style="margin-bottom:40px;scroll-margin-top:20px">
        ...
        <div class="reader-text writer-editable" contenteditable="true" data-nid="${n.id}" spellcheck="false">${md2html(typo(text))}</div>
      </div>`;
    });
  }
  const _ri=$('#reader-inner'); if(!_ri) return; _ri.innerHTML=html;

  // Сохраняем правки из contenteditable обратно в node.output
  document.querySelectorAll('.writer-editable').forEach(function(el){
    el.addEventListener('input',function(){
      var nd=node(el.dataset.nid); if(!nd) return;
      nd.output=el.innerText||el.textContent||'';
      clearTimeout(el._saveTimer);
      el._saveTimer=setTimeout(function(){ save(); updateCoAuthorHints(); },1200);
    });
  });

  // Обновляем подсказку текущей главы в топбаре
  var _rChapters=(typeof bookNodes==='function')?bookNodes():[];
  var curCh=_rChapters&&_rChapters[0];
  if(curCh){
    var hint=document.querySelector('#tb-chapter-hint');
    if(hint) hint.textContent='· '+chapterTitleOf(curCh,0)+' · черновик';
  }

  updateCoAuthorHints();

  document.querySelectorAll('.rver-btn').forEach(function(btn){
    btn.addEventListener('click',function(){
      var nd=node(btn.dataset.nid); if(!nd||!Array.isArray(nd.versions)) return;
      var vers=nd.versions.slice().reverse();
      var rows=vers.map(function(v,i){
        var isLast=i===0;
        var prev=esc((v.out||'').slice(0,200));
        return '<div class="ver-row'+(isLast?' ver-cur':'')+'"><div class="ver-meta">'+(isLast?'<b>Текущая версия</b>':'Версия '+(vers.length-i))+' · ~'+(v.words||0).toLocaleString('ru-RU')+' слов</div><div class="ver-prev">'+prev+'…</div>'
          +(!isLast?'<button class="btn ghost xs ver-restore" data-nid="'+nd.id+'" data-vi="'+(vers.length-1-i)+'">↩ Восстановить</button>':'')+'</div>';
      }).join('');
      openDrawer('⏱ История: «'+esc(nd.name)+'»','<p class="hint" style="margin-top:0">Версии сохраняются при каждом прогоне. Восстановите любую предыдущую.</p><div class="ver-list">'+rows+'</div>',function(b){
        b.querySelectorAll('.ver-restore').forEach(function(rb){
          rb.addEventListener('click',function(){
            var nd2=node(rb.dataset.nid); if(!nd2) return;
            var vi=+rb.dataset.vi;
            if(nd2.versions&&nd2.versions[vi]){ nd2.output=nd2.versions[vi].out; save(); renderReader(); closeDrawer(); toast('Версия восстановлена','ok'); }
          });
        });
      });
    });
  ...
  (function initInlineAI(){
    const ri=document.querySelector('#reader-inner'); if(!ri) return;
    let _menu=null;
    const ACTS=[
      {id:'darker',  ico:'🌑',lbl:'Мрачнее',   sys:'Перепиши в более мрачном напряжённом тоне. Сохрани смысл.'},
      {id:'lighter', ico:'☀️', lbl:'Светлее',   sys:'Перепиши в более лёгком оптимистичном тоне. Сохрани смысл.'},
      {id:'expand',  ico:'🔍',lbl:'Расширить',  sys:'Расширь в 2 раза: больше деталей, диалога, внутреннего состояния.'},
      {id:'shorten', ico:'✂️', lbl:'Сократить',  sys:'Сократи в 2 раза. Только самое главное.'},
      {id:'dialog',  ico:'💬',lbl:'В диалог',   sys:'Преобразуй в живой диалог между персонажами. Сохрани смысл.'},
    ];
    const rm=()=>{ if(_menu){_menu.remove();_menu=null;} };
    document.addEventListener('mousedown',e=>{if(_menu&&!_menu.contains(e.target))rm();});

    ri.addEventListener('mouseup',()=>{
      rm();
      const sel=window.getSelection();
      if(!sel||sel.isCollapsed||sel.toString().trim().length<20) return;
      const txt=sel.toString().trim();
      const rect=sel.getRangeAt(0).getBoundingClientRect();
      const m=document.createElement('div');
      m.className='aim';
      m.style.cssText='position:fixed;top:'+(rect.top-52)+'px;left:'+Math.max(8,Math.min(rect.left,window.innerWidth-320))+'px;z-index:9999';
      m.innerHTML=ACTS.map(a=>'<button class="aim-btn" data-id="'+a.id+'">'+a.ico+' '+a.lbl+'</button>').join('');
      document.body.appendChild(m);
      _menu=m;

      m.querySelectorAll('.aim-btn').forEach(btn=>btn.onclick=async()=>{
        if(!hasKey()){toast('Нужен API-ключ','err');rm();return;}
        const act=ACTS.find(a=>a.id===btn.dataset.id);
        rm();
        const ov=document.createElement('div');
        ov.className='aro';
        ov.innerHTML='<div class="aro-h"><span>'+act.ico+' '+act.lbl+'</span><button class="icon-btn aro-x">✕</button></div>'
          +'<div class="aro-orig"><div class="aro-lbl">Оригинал</div><div class="aro-t">'+esc(txt.slice(0,300))+(txt.length>300?'…':'')+'</div></div>'
          +'<div class="aro-new"><div class="aro-lbl">Вариант ИИ</div><div class="aro-t aro-spin">⏳ Генерирую…</div></div>'
          +'<div class="aro-btns" style="display:none"><button class="btn ghost sm aro-copy">📋 Скопировать</button><button class="btn ghost sm aro-retry">🔄 Ещё раз</button></div>';
        document.body.appendChild(ov);
        ov.querySelector('.aro-x').onclick=()=>ov.remove();

        const go=async()=>{
          const rt=ov.querySelector('.aro-spin')||ov.querySelector('.aro-new .aro-t');
          if(rt){rt.className='aro-t aro-spin';rt.textContent='⏳ Генерирую…';}
          try{
            const c={baseURL:state.global.baseURL,apiKey:pickKey(),model:state.global.model,temperature:0.9};
            const r=await callLLM(c,[{role:'system',content:act.sys+' Верни ТОЛЬКО текст.'},
              {role:'user',content:txt}]);
            if(rt){rt.className='aro-t';rt.textContent=r.trim();}
            ov.querySelector('.aro-btns').style.display='flex';
            ov.querySelector('.aro-copy').onclick=()=>{navigator.clipboard?.writeText(r.trim());toast('Скопировано','ok');};
            ov.querySelector('.aro-retry').onclick=go;
          }catch(e){if(rt){rt.className='aro-t';rt.textContent='Ошибка: '+e.message.slice(0,80);}}
        };
        go();
      });
    });
...
function showCompletionBanner(){
  ...
  const cb=$('#completion-banner'); if(!cb) return;
...
function openAntiplagiat(){
  // Собираем чистую прозу книги
  const chapters=bookNodes();
  const text=chapters.map((n,i)=>{
    const title=chapterTitleOf(n,i);
    return `${title}\n\n${cleanProse(n)}`;
  }).join('\n\n---\n\n');
  if(!text.trim()){ toast('Нет текста — сначала запустите пайплайн','warn'); return; }
  // Копируем в буфер
  navigator.clipboard?.writeText(text).catch(()=>{});
  openDrawer('🔍 Проверка на плагиат',`
    <p class="hint" style="margin-top:0">Текст книги скопирован в буфер обмена. Откройте сервис и вставьте текст (<b>Ctrl+V</b>).</p>
    <div class="ap-services">
      <a class="ap-link" href="https://text.ru/antiplagiat" target="_blank" rel="noopener">
        <span class="ap-logo">📄</span>
        <div><b>Text.ru</b><span class="ap-note">Бесплатно · до 100 000 знаков · процент уникальности</span></div>
      </a>
      <a class="ap-link" href="https://www.etxt.ru/antiplagiat/" target="_blank" rel="noopener">
        <span class="ap-logo">📝</span>
        <div><b>Etxt Antiplagiat</b><span class="ap-note">Бесплатно · до 10 000 знаков · ИИ-детектор</span></div>
      </a>
      <a class="ap-link" href="https://antiplagiat.ru" target="_blank" rel="noopener">
        <span class="ap-logo">🏛</span>
        <div><b>Antiplagiat.ru</b><span class="ap-note">Профессиональный · платный · для издательств и вузов</span></div>
      </a>
      <a class="ap-link" href="https://originality.ai" target="_blank" rel="noopener">
        <span class="ap-logo">🤖</span>
        <div><b>Originality.ai</b><span class="ap-note">Лучший детектор ИИ-текста · англоязычный сервис</span></div>
      </a>
      <a class="ap-link" href="https://gptzero.me" target="_blank" rel="noopener">
        <span class="ap-logo">🔬</span>
        <div><b>GPTZero</b><span class="ap-note">Детектор ИИ · бесплатно до 5 000 слов</span></div>
      </a>
    </div>
    <div class="ap-stat">
      Объём текста: <b>${text.length.toLocaleString('ru-RU')} символов</b> · <b>${(text.match(/\S+/g)||[]).length.toLocaleString('ru-RU')} слов</b>
    </div>
    <div class="ap-copy-wrap">
      <textarea class="ap-preview" rows="6" readonly>${esc(text.slice(0,800))}${text.length>800?'…':''}</textarea>
      <button class="btn ok sm" id="ap-copy-btn">📋 Скопировать снова</button>
    </div>
  `,b=>{
    b.querySelector('#ap-copy-btn')?.addEventListener('click',()=>{
      navigator.clipboard?.writeText(text).then(()=>toast('Скопировано в буфер','ok')).catch(()=>toast('Не удалось — скопируйте из поля ниже вручную','warn'));
    });
  });
}
...
function showOnboarding(){
  ...
  el.querySelector('#ob-skip').onclick=()=>{ dismiss(); switchView('simple'); };
...
render();
// Новые пользователи начинают с мастера «Просто»
if(!state.global.apiKey && state.nodes.length===0){ switchView('simple'); }
// Кнопки баннера завершения
{ const _e=$('#cb-read'); if(_e) _e.onclick=()=>switchView('reader'); }
{ const _e=$('#cb-docx'); if(_e) _e.onclick=exportDocx; }
{ const _e=$('#cb-epub'); if(_e) _e.onclick=exportEpub; }
{ const _e=$('#cb-dismiss'); if(_e) _e.onclick=hideCompletionBanner; }
...
function ctbSync(){
  ...
  const zl=$('#ctb-zoom-lbl'); if(zl && zl.childNodes[0]) zl.childNodes[0].textContent=_zoomLevel+'%';
}
