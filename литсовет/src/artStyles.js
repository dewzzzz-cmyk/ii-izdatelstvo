...
export const ART_STYLES = [
  { id:'watercolor',   name:'Акварель',              blurb:'Мягкие цветовые растёки, видимая текстура бумаги.', genres:['роман','повесть','любовный роман','биографическая проза','ромфант'], promptFragment:'watercolor illustration, soft color bleed, visible paper texture' },
  { id:'oil',          name:'Масляная живопись',     blurb:'Густые мазки, насыщенная текстура холста.', genres:['роман','повесть','исторический роман'], promptFragment:'oil painting, thick brushstrokes, rich canvas texture' },
  ...
  { id:'fantasyart',   name:'Фэнтези-концепт-арт',   blurb:'Живописный, драматичное освещение, эпический масштаб.', genres:['фэнтези','ироничное фэнтези','приключения','ромфант'], promptFragment:'fantasy concept art, painterly, dramatic lighting, epic scale' },
  { id:'vintage',      name:'Винтаж',                blurb:'Печатная фактура середины века, растровые точки.', genres:['исторический роман','детектив','альтернативная история','дамский детектив'], promptFragment:'vintage book illustration, mid-century print texture, halftone dots' },
  ...
  { id:'cyberpunk',    name:'Киберпанк',             blurb:'Неоновые акценты, глянцевые футуристичные поверхности.', genres:['фантастика','триллер','литрпг'], promptFragment:'cyberpunk digital art, neon accents, glossy futuristic surfaces' },
