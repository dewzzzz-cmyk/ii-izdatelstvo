...
export function defaultState(){
  return {
    ...
    project: {
      ...
      // До трёх жанров в одной книге (genres[0] === genre — ведущий).
      // Одна строка не выражала обычный случай «фэнтези + комедия +
      // приключения»: жанровые заметки выбирались первым совпадением, и
      // остальные жанры до агентов не доходили вовсе.
      genres: [],
