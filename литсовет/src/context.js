...
export const CHAPTER_ARC_NOTE = {
  // Рамочные главы. Пролог чаще всего проваливается одинаково: вместо сцены
  // получается справка о мире голосом рассказчика, и читатель бросает книгу,
  // не встретив ни одного живого человека. Поэтому здесь требование к прозе
  // жёстче, чем к обычной главе, а не мягче.
  пролог: 'Глава книги: ПРОЛОГ — это ПОЛНОЦЕННАЯ СЦЕНА, а не вступление и не справка. Живой человек в конкретном месте и времени, событие, его выбор. НЕ объясняй устройство мира, не пересказывай предысторию, не говори голосом рассказчика «за кадром». Читатель должен унести отсюда тревожное знание, которого у главного героя ещё нет.',
  эпилог: 'Глава книги: ЭПИЛОГ — показывай ЦЕНУ произошедшего спустя время: как герой живёт теперь, что необратимо изменилось. Не пересказывай финал, не объясняй смысл книги, не подводи итоги словами — только сцена и деталь.',
