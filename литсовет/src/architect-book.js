...
const ARC_DISTRIBUTION_NOTE = 'РАСПРЕДЕЛЕНИЕ ДУГ (arc) — обязательное: у книги должна быть полная арка. Первая глава — «завязка». ПОСЛЕДНЯЯ глава — «развязка» (даже если финал открытый: развязка ≠ закрытие всех линий, это глава, где сходится главный конфликт). Ровно одна глава ближе к концу (обычно предпоследняя, при 3 главах — последняя) — «кульминация». Все остальные — «развитие». НЕ помечай «развитием» последние главы: если по смыслу глава — финал или пик, ярлык обязан это отражать. Проверь итоговый список дуг перед выдачей: последовательность вида «завязка, развитие, развитие, развитие» — ошибка, её нужно исправить.';
...
export function structureEvalMessages(state, skeleton, prevEval){
  ...
  const sys = [
    ...
    '• Ярлыки дуг (arc в квадратных скобках у каждой главы): проверь их как список. Полная арка книги — первая глава «завязка», последняя «развязка», одна ближе к концу «кульминация», остальные «развитие». Если последние главы помечены «развитием», а по содержанию это финал или пик — это ошибка разметки, назови её и укажи, какой arc должен быть у каких глав. Последовательность вида «завязка, развитие, развитие, развитие» — всегда ошибка.',
